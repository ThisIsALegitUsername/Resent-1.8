...
public abstract class RenderLiving extends Render {
	...
	protected void passSpecialRender(EntityLiving par1EntityLiving, double par2, double par4, double par6) {
		if (Minecraft.isGuiEnabled() && par1EntityLiving != this.renderManager.livingPlayer
				...
				&& (par1EntityLiving.func_94059_bO()
						|| par1EntityLiving.func_94056_bM() && par1EntityLiving == this.renderManager.field_96451_i) || W.selfNametag().isEnabled() && par1EntityLiving instanceof EntityPlayer && !par1EntityLiving.isInvisible()) {
			float var8 = 1.6F;
			...
			if (var10 < (double) (var12 * var12) || W.selfNametag().isEnabled() && par1EntityLiving instanceof EntityPlayer && !par1EntityLiving.isInvisible()) {
	...
	protected void renderLivingLabel(EntityLiving par1EntityLiving, String par2Str, double par3, double par5, double par7, int par9) {
		...
		if (var10 <= (double) (par9 * par9)) {
			...
			EaglerAdapter.glPushMatrix();
			EaglerAdapter.glTranslatef((float) par3 + 0.0F, (float) par5 + par1EntityLiving.height + 0.5F,
					(float) par7);
			EaglerAdapter.glNormal3f(0.0F, 1.0F, 0.0F);
			EaglerAdapter.glRotatef(-this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
			EaglerAdapter.glRotatef(this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
			...
			if (par1EntityLiving instanceof EntityOtherPlayerMP) {
				if (EaglerAdapter.getVoiceStatus() == Voice.VoiceStatus.CONNECTED) {
					...
					if ((mute || EaglerAdapter.getVoiceSpeaking().contains(nm))
							&& renderManager.voiceTagsDrawnThisFrame.add(nm)) {
						...
						var15.startDrawingQuads();
						var15.addVertexWithUV(0, 1.0, 0, (double) ((float) (u + 0.2f) * var7),
								(double) ((float) (v + 32 - 0.2f) * var8));
						var15.addVertexWithUV(1.0, 1.0, 0, (double) ((float) (u + 32 - 0.2f) * var7),
								(double) ((float) (v + 32 - 0.2f) * var8));
						var15.addVertexWithUV(1.0, 0, 0, (double) ((float) (u + 32 - 0.2f) * var7),
								(double) ((float) (v + 0.2f) * var8));
						var15.addVertexWithUV(0, 0, 0, (double) ((float) (u + 0.2f) * var7),
								(double) ((float) (v + 0.2f) * var8));
						var15.draw();
