...
public class GuiTextField extends Gui {
	...
	public void mouseClicked(int par1, int par2, int par3) {
		...
		if (this.isFocused && par3 == 0) {
			...
			String var6 = this.fontRenderer.trimStringToWidth(this.text.substring(this.lineScrollOffset),
					this.getWidth());
		...
		if (this.getVisible()) {
			if (this.getEnableBackgroundDrawing()) {
				if (!custom) {
					...
					RenderUtils.drawRoundedRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1,
							this.yPos + this.height + 1, 2, -6250336);
					RenderUtils.drawRoundedRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height,
							2, -16777216);
				}
			}
			...
			String var4 = this.fontRenderer.trimStringToWidth(this.text.substring(this.lineScrollOffset),
					this.getWidth());
			...
			if (var6) {
				if (var13) {
					if (!custom)
						Gui.drawRect(var11, var8 - 1, var11 + 1, var8 + 1 + this.fontRenderer.FONT_HEIGHT,
								var1 | 0xFF000000);
					else
						RenderUtils.drawRoundedRect(var11, var8 - 1, var11 + 1,
								var8 + 1 + this.fontRenderer.FONT_HEIGHT, 2, var1 | 0xFF000000);
				} else {
