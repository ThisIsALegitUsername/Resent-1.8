...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float par1, boolean par2, int par3, int par4) {
		...
		if (this.mc.isDemo()) {
			...
			if (this.mc.theWorld.getTotalWorldTime() >= 120500L) {
				...
				var35 = String.format(StatCollector.translateToLocal("demo.remainingTime"), new Object[] {
		...
		if (this.mc.gameSettings.showDebugInfo) {
			...
			if (EaglerAdapter._wisWebGL()) {
				...
				var45 = "Used memory: " + var44 * 100L / var39 + "% (" + var44 / 1024L / 1024L + "MB) of "
						+ var39 / 1024L / 1024L + "MB";
				this.drawString(var8, var45, var6 - var8.getStringWidth(var45) - 2, 2, 14737632);
			...
			this.drawString(var8, "x: " + doubleToShorterString(this.mc.thePlayer.posX) + " (" + var47 + ") // c: "
					+ (var47 >> 4) + " (" + (var47 & 15) + ")", 2, 92, 14737632);
			this.drawString(var8, "y: " + doubleToShorterString(this.mc.thePlayer.posY) + " (" + var22 + ") (feet pos)",
					2, 100, 14737632);
			this.drawString(var8, "z: " + doubleToShorterString(this.mc.thePlayer.posZ) + " (" + var23 + ") // c: "
					+ (var23 >> 4) + " (" + (var23 & 15) + ")", 2, 108, 14737632);
			var24 = MathHelper.floor_double((double) (this.mc.thePlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
			this.drawString(var8, "f: " + var24 + " (" + Direction.directions[var24] + ") / "
					+ MathHelper.wrapAngleTo180_float(this.mc.thePlayer.rotationYaw), 2, 116, 14737632);
			this.drawString(var8, "Press F+6 to " + (mc.gameSettings.showCoordinates ? "disable" : "enable")
					+ " showing coords in ingame GUI", 2, 135, 0xFFFFFFFF);
			...
			// this.drawString(var8, String.format("ws: %.3f, fs: %.3f, g: %b, fl: %d", new
			// Object[] { Float.valueOf(this.mc.thePlayer.capabilities.getWalkSpeed()),
			// Float.valueOf(this.mc.thePlayer.capabilities.getFlySpeed()),
			// Boolean.valueOf(this.mc.thePlayer.onGround),
			// Integer.valueOf(this.mc.theWorld.getHeightValue(var47, var23)) }), 2, 104,
			// 14737632);
			var45 = "opengl emulator status - v1.0";
			this.drawString(var8, var45, var6 - var8.getStringWidth(var45) - 2, offset + 36, 14737632);
			var45 = "lists: " + EaglerAdapter.getDisplayListCount() + ", upload: "
					+ (EaglerAdapter.getBitsPerSecond() / 1000000) + "mbps";
			this.drawString(var8, var45, var6 - var8.getStringWidth(var45) - 2, offset + 46, 14737632);
			var45 = "verts: " + (EaglerAdapter.getVertexesPerSecond() / 1000) + "k, triangles: "
					+ (EaglerAdapter.getTrianglesPerSecond() / 1000) + "k";
			...
			var8.drawStringWithShadow(this.mc.renderGlobal.getDebugInfoShort(), 999, 999, 16777215);

			if (mc.gameSettings.showCoordinates) {
				var8.drawStringWithShadow("x: " + MathHelper.floor_double(this.mc.thePlayer.posX) + ", y: "
						+ MathHelper.floor_double(this.mc.thePlayer.posY) + ", z: "
						+ MathHelper.floor_double(this.mc.thePlayer.posZ), 999, 999, 16777215);
			}
			...
			if (IntegratedServer.isWorldRunning()) {
				...
				List<String> info = IntegratedServer.getTPS();
				for (int i = 0, size = info.size(); i < size; ++i) {
					var8.drawStringWithShadow(info.get(i), (int) (var6 / 0.75f) - var8.getStringWidth(info.get(i)) - 2,
							12 + i * 10, 14737632);
				}
			}
			/*
			 ...
			 * var8.drawStringWithShadow(str, (var6 * 4 / 3) - 2 - var8.getStringWidth(str)
			 * - offset, 2 + offset2, 0xFFDDDD);
			 * str = "eaglercraft: " + ConfigConstants.version;
			 * var8.drawStringWithShadow(str, (var6 * 4 / 3) - 2 - var8.getStringWidth(str)
			 * - offset, 12 + offset2, 14737632);
			 * }
			 */
			EaglerAdapter.glPopMatrix();
		...
		if (var42 != null && W.scoreboard().isEnabled()) {
		...
		if (this.mc.gameSettings.keyBindPlayerList.pressed && (!this.mc.isIntegratedServerRunning()
	...
	private void func_96136_a(ScoreObjective par1ScoreObjective, int par2, int par3, FontRenderer par4FontRenderer) {
		...
		if (var6.size() <= 15) {
			...
			for (Iterator var8 = var6.iterator(); var8
				...
				var11 = ScorePlayerTeam.func_96667_a(var10, var9.func_96653_e()) + ": " + EnumChatFormatting.RED
						+ var9.func_96652_c();
			}
			...
			while (var13.hasNext()) {
				...
				if (W.scoreboardNumbers().isEnabled()) {
					par4FontRenderer.drawString(var17, var20 - par4FontRenderer.getStringWidth(var17), var19,
							553648127);
				}
				...
				if (var12 == var6.size()) {
					...
					par4FontRenderer.drawString(var21, var25 + var7 / 2 - par4FontRenderer.getStringWidth(var21) / 2,
	...
	private void renderVignette(float par1, int par2, int par3) {
		...
		EaglerAdapter.glColor4f(this.prevVignetteBrightness, this.prevVignetteBrightness, this.prevVignetteBrightness,
				1.0F);
	...
	public void updateTick() {
		...
		if (this.mc.thePlayer != null) {
			...
			} else if (this.highlightingItemStack != null && var1.itemID == this.highlightingItemStack.itemID
