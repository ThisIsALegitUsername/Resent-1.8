...
public class GuiIngameMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(lanButton = new GuiButton(7, this.width / 2 + 2, this.height / 4 + 96 + var1, 98, 20,
				StatCollector.translateToLocal(IntegratedServerLAN.isLANOpen() ? "menu.closeLan" : "menu.shareToLan")));
		...
		switch (par1GuiButton.id) {
			...
			case 7:
				if (IntegratedServerLAN.isLANOpen()) {
					closingLan = true;
					mc.displayGuiScreen(new GuiYesNo(this, StatCollector.translateToLocal("networkSettings.delete"),
							StatCollector.translateToLocal("lanServer.wouldYouLikeToKick"), 0));
				} else {
