...
public class Client {
	...
	private static void showCrashScreen(String t) {
		if(!isCrashed) {
			...
			StringBuilder str = new StringBuilder();
			str.append("Resent crashed! Please dm hooman#1196 about this crash. If you're launching for the first time, don't worry! Just refresh and you'll be fine! Github: " + ConfigConstants.forkMe + "\n\n");
			str.append(t);
			str.append('\n').append('\n');
