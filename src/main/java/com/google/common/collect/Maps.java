...
public final class Maps {
    ...
    private static final class FilteredMapValues<K, V> extends Maps.Values<K, V> {
        ...
        private boolean removeIf(Predicate<? super V> valuePredicate) {
            return Iterables.removeIf(unfiltered.entrySet(), Predicates.<Entry<K, V>>and(predicate, Maps.<V>valuePredicateOnEntries(valuePredicate)));
        }
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        class KeySet extends Maps.KeySet<K, V> {
            ...
            private boolean removeIf(Predicate<? super K> keyPredicate) {
                return Iterables.removeIf(unfiltered.entrySet(), Predicates.<Entry<K, V>>and(predicate, Maps.<K>keyPredicateOnEntries(keyPredicate)));
            }
