...
public final class ByteStreams {
     ...
     */
    @Deprecated
    public static InputSupplier<EaglerInputStream> newInputStreamSupplier(final byte[] b, final int off, final int len) {
    ...
    public static InputSupplier<InputStream> join(final Iterable<? extends InputSupplier<? extends InputStream>> suppliers) {
        ...
        Iterable<ByteSource> sources = Iterables.transform(
            suppliers,
