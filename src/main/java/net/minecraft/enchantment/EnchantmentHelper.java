...
public class EnchantmentHelper {
     ...
     */
    public static int calcItemStackEnchantability(EaglercraftRandom parRandom, int parInt1, int parInt2, ItemStack parItemStack) {
     ...
     */
    public static List<EnchantmentData> buildEnchantmentList(EaglercraftRandom randomIn, ItemStack itemStackIn, int parInt1) {
        ...
        for (Enchantment enchantment : Enchantment.enchantmentsBookList) {
            if (enchantment != null && (enchantment.type.canEnchantItem(item) || flag)) {
                for (int i = enchantment.getMinLevel(); i <= enchantment.getMaxLevel(); ++i) {
                    if (parInt1 >= enchantment.getMinEnchantability(i) && parInt1 <= enchantment.getMaxEnchantability(i)) {
                        if (hashmap == null) {
