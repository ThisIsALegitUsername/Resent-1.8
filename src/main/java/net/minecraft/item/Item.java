...
public class Item {
    ...
    protected static final EaglercraftUUID itemModifierUUID = EaglercraftUUID.fromString("CB3F55D3-645C-4F38-A497-9C13A33DB5CF");
    ...
    public static void registerItems() {
        ...
        registerItem(370, (String) "ghast_tear", (new Item()).setUnlocalizedName("ghastTear").setPotionEffect(PotionHelper.ghastTearEffect).setCreativeTab(CreativeTabs.tabBrewing));
        ...
        registerItem(414, (String) "rabbit_foot", (new Item()).setUnlocalizedName("rabbitFoot").setPotionEffect(PotionHelper.rabbitFootEffect).setCreativeTab(CreativeTabs.tabBrewing));
