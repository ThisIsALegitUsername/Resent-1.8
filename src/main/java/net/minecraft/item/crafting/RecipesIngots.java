...
public class RecipesIngots {
    ...
    public void addRecipes(CraftingManager parCraftingManager) {
        ...
        for (int i = 0; i < this.recipeItems.length; ++i) {
            ...
            parCraftingManager.addRecipe(new ItemStack(block), new Object[] { "###", "###", "###", Character.valueOf('#'), itemstack });
            parCraftingManager.addRecipe(itemstack, new Object[] { "#", Character.valueOf('#'), block });
        }

        parCraftingManager.addRecipe(new ItemStack(Items.gold_ingot), new Object[] { "###", "###", "###", Character.valueOf('#'), Items.gold_nugget });
        parCraftingManager.addRecipe(new ItemStack(Items.gold_nugget, 9), new Object[] { "#", Character.valueOf('#'), Items.gold_ingot });
    }
}
