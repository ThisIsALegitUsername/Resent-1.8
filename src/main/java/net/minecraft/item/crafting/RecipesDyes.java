...
public class RecipesDyes {
	...
	public void addRecipes(CraftingManager parCraftingManager) {
		for (int i = 0; i < 16; ++i) {
			parCraftingManager.addShapelessRecipe(new ItemStack(Blocks.wool, 1, i), new ItemStack(Items.dye, 1, 15 - i), new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, 0));
            parCraftingManager.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, 15 - i),
                    "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.hardened_clay),
                    Character.valueOf('X'), new ItemStack(Items.dye, 1, i));
            parCraftingManager.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - i),
                    "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.glass),
                    Character.valueOf('X'), new ItemStack(Items.dye, 1, i));
            parCraftingManager.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, i),
                    "###", "###", Character.valueOf('#'), new ItemStack(Blocks.stained_glass, 1, i));
		}
		...
		for (int j = 0; j < 16; ++j) {
            parCraftingManager.addRecipe(new ItemStack(Blocks.carpet, 3, j),
                    "##", Character.valueOf('#'), new ItemStack(Blocks.wool, 1, j));
		}
