...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Blocks.oak_fence, 3),
				"W#W", "W#W", Character.valueOf('#'), Items.stick, Character.valueOf('W'),
		...
		this.addRecipe(new ItemStack(Blocks.oak_fence_gate, 1),
				"#W#", "#W#", Character.valueOf('#'), Items.stick, Character.valueOf('W'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.OAK.getMetadata()));
		...
		this.addRecipe(new ItemStack(Blocks.dark_oak_fence_gate, 1),
				"#W#", "#W#", Character.valueOf('#'), Items.stick, Character.valueOf('W'),
				new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4));
		this.addRecipe(new ItemStack(Blocks.jukebox, 1), "###", "#X#", "###", Character.valueOf('#'),
				Blocks.planks, Character.valueOf('X'), Items.diamond);
		this.addRecipe(new ItemStack(Items.lead, 2), "~~ ", "~O ", "  ~", Character.valueOf('~'),
				Items.string, Character.valueOf('O'), Items.slime_ball);
		this.addRecipe(new ItemStack(Blocks.noteblock, 1), "###", "#X#", "###", Character.valueOf('#'),
				Blocks.planks, Character.valueOf('X'), Items.redstone);
		this.addRecipe(new ItemStack(Blocks.bookshelf, 1), "###", "XXX", "###", Character.valueOf('#'),
				Blocks.planks, Character.valueOf('X'), Items.book);
		this.addRecipe(new ItemStack(Blocks.snow, 1),
				"##", "##", Character.valueOf('#'), Items.snowball);
		this.addRecipe(new ItemStack(Blocks.snow_layer, 6),
				"###", Character.valueOf('#'), Blocks.snow);
		this.addRecipe(new ItemStack(Blocks.clay, 1),
				"##", "##", Character.valueOf('#'), Items.clay_ball);
		...
		this.addRecipe(new ItemStack(Blocks.tnt, 1), "X#X", "#X#", "X#X", Character.valueOf('X'),
		...
		this.addRecipe(new ItemStack(Blocks.wooden_slab, 6, 0), "###", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.OAK.getMetadata()));
		...
		this.addRecipe(new ItemStack(Items.oak_door, 3), "##", "##", "##", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.OAK.getMetadata()));
		this.addRecipe(new ItemStack(Items.spruce_door, 3), "##", "##", "##", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.SPRUCE.getMetadata()));
		this.addRecipe(new ItemStack(Items.birch_door, 3), "##", "##", "##", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.BIRCH.getMetadata()));
		this.addRecipe(new ItemStack(Items.jungle_door, 3), "##", "##", "##", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.JUNGLE.getMetadata()));
		this.addRecipe(new ItemStack(Items.acacia_door, 3), "##", "##", "##", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.ACACIA.getMetadata()));
		this.addRecipe(new ItemStack(Items.dark_oak_door, 3), "##", "##", "##", Character.valueOf('#'),
		...
		this.addRecipe(new ItemStack(Blocks.iron_trapdoor, 1),
				"##", "##", Character.valueOf('#'), Items.iron_ingot);
		this.addRecipe(new ItemStack(Items.sign, 3), "###", "###", " X ", Character.valueOf('#'),
				Blocks.planks, Character.valueOf('X'), Items.stick);
		this.addRecipe(new ItemStack(Items.cake, 1),
				"AAA", "BEB", "CCC", Character.valueOf('A'), Items.milk_bucket, Character.valueOf('B'),
		...
		this.addRecipe(new ItemStack(Blocks.torch, 4),
				"X", "#", Character.valueOf('X'), Items.coal, Character.valueOf('#'), Items.stick);
		this.addRecipe(new ItemStack(Blocks.torch, 4), "X", "#", Character.valueOf('X'),
		...
		this.addRecipe(new ItemStack(Blocks.rail, 16), "X X", "X#X", "X X", Character.valueOf('X'),
				Items.iron_ingot, Character.valueOf('#'), Items.stick);
		this.addRecipe(new ItemStack(Blocks.golden_rail, 6), "X X", "X#X", "XRX", Character.valueOf('X'),
		...
		this.addRecipe(new ItemStack(Blocks.activator_rail, 6),
				"XSX", "X#X", "XSX", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('#'),
				Blocks.redstone_torch, Character.valueOf('S'), Items.stick);
		this.addRecipe(new ItemStack(Blocks.detector_rail, 6),
				"X X", "X#X", "XRX", Character.valueOf('X'), Items.iron_ingot, Character.valueOf('R'),
		...
		this.addRecipe(new ItemStack(Items.cauldron, 1),
				"# #", "# #", "###", Character.valueOf('#'), Items.iron_ingot);
		this.addRecipe(new ItemStack(Items.brewing_stand, 1), " B ", "###", Character.valueOf('#'),
				Blocks.cobblestone, Character.valueOf('B'), Items.blaze_rod);
		this.addRecipe(new ItemStack(Blocks.lit_pumpkin, 1), "A", "B", Character.valueOf('A'),
				Blocks.pumpkin, Character.valueOf('B'), Blocks.torch);
		this.addRecipe(new ItemStack(Items.chest_minecart, 1), "A", "B", Character.valueOf('A'),
				Blocks.chest, Character.valueOf('B'), Items.minecart);
		this.addRecipe(new ItemStack(Items.furnace_minecart, 1), "A", "B", Character.valueOf('A'),
				Blocks.furnace, Character.valueOf('B'), Items.minecart);
		this.addRecipe(new ItemStack(Items.tnt_minecart, 1),
				"A", "B", Character.valueOf('A'), Blocks.tnt, Character.valueOf('B'), Items.minecart);
		this.addRecipe(new ItemStack(Items.hopper_minecart, 1), "A", "B", Character.valueOf('A'),
		...
		this.addRecipe(new ItemStack(Blocks.oak_stairs, 4), "#  ", "## ", "###", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.OAK.getMetadata()));
		...
		this.addRecipe(new ItemStack(Blocks.dark_oak_stairs, 4),
				"#  ", "## ", "###", Character.valueOf('#'),
				new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4));
		this.addRecipe(new ItemStack(Items.fishing_rod, 1), "  #", " #X", "# X", Character.valueOf('#'),
				Items.stick, Character.valueOf('X'), Items.string);
		this.addRecipe(new ItemStack(Items.carrot_on_a_stick, 1), "# ", " X", Character.valueOf('#'),
		...
		this.addRecipe(new ItemStack(Blocks.quartz_stairs, 4),
				"#  ", "## ", "###", Character.valueOf('#'), Blocks.quartz_block);
		this.addRecipe(new ItemStack(Items.painting, 1), "###", "#X#", "###", Character.valueOf('#'),
				Items.stick, Character.valueOf('X'), Blocks.wool);
		this.addRecipe(new ItemStack(Items.item_frame, 1), "###", "#X#", "###", Character.valueOf('#'),
				Items.stick, Character.valueOf('X'), Items.leather);
		this.addRecipe(new ItemStack(Items.golden_apple, 1, 0), "###", "#X#", "###",
				Character.valueOf('#'), Items.gold_ingot, Character.valueOf('X'), Items.apple);
		this.addRecipe(new ItemStack(Items.golden_apple, 1, 1), "###", "#X#", "###",
				Character.valueOf('#'), Blocks.gold_block, Character.valueOf('X'), Items.apple);
		this.addRecipe(new ItemStack(Items.golden_carrot, 1, 0), "###", "#X#", "###",
				Character.valueOf('#'), Items.gold_nugget, Character.valueOf('X'), Items.carrot);
		this.addRecipe(new ItemStack(Items.speckled_melon, 1), "###", "#X#", "###",
				Character.valueOf('#'), Items.gold_nugget, Character.valueOf('X'), Items.melon);
		this.addRecipe(new ItemStack(Blocks.lever, 1), "X", "#", Character.valueOf('#'),
				Blocks.cobblestone, Character.valueOf('X'), Items.stick);
		this.addRecipe(new ItemStack(Blocks.tripwire_hook, 2), "I", "S", "#", Character.valueOf('#'),
		...
		this.addRecipe(new ItemStack(Blocks.redstone_torch, 1),
				"X", "#", Character.valueOf('#'), Items.stick, Character.valueOf('X'), Items.redstone);
		this.addRecipe(new ItemStack(Items.repeater, 1),
				"#X#", "III", Character.valueOf('#'), Blocks.redstone_torch, Character.valueOf('X'),
		...
		this.addRecipe(new ItemStack(Items.comparator, 1),
				" # ", "#X#", "III", Character.valueOf('#'), Blocks.redstone_torch,
				Character.valueOf('X'), Items.quartz, Character.valueOf('I'),
				new ItemStack(Blocks.stone, 1, BlockStone.EnumType.STONE.getMetadata()));
		this.addRecipe(new ItemStack(Items.clock, 1), " # ", "#X#", " # ", Character.valueOf('#'),
				Items.gold_ingot, Character.valueOf('X'), Items.redstone);
		this.addRecipe(new ItemStack(Items.compass, 1), " # ", "#X#", " # ", Character.valueOf('#'),
				Items.iron_ingot, Character.valueOf('X'), Items.redstone);
		this.addRecipe(new ItemStack(Items.map, 1), "###", "#X#", "###", Character.valueOf('#'),
				Items.paper, Character.valueOf('X'), Items.compass);
		this.addRecipe(new ItemStack(Blocks.stone_button, 1), "#", Character.valueOf('#'),
				new ItemStack(Blocks.stone, 1, BlockStone.EnumType.STONE.getMetadata()));
		this.addRecipe(new ItemStack(Blocks.wooden_button, 1),
				"#", Character.valueOf('#'), Blocks.planks);
		this.addRecipe(new ItemStack(Blocks.stone_pressure_plate, 1), "##", Character.valueOf('#'),
				new ItemStack(Blocks.stone, 1, BlockStone.EnumType.STONE.getMetadata()));
		...
		this.addRecipe(new ItemStack(Blocks.daylight_detector),
				"GGG", "QQQ", "WWW", Character.valueOf('G'), Blocks.glass, Character.valueOf('Q'),
				Items.quartz, Character.valueOf('W'), Blocks.wooden_slab);
		this.addRecipe(new ItemStack(Blocks.hopper), "I I", "ICI", " I ", Character.valueOf('I'),
				Items.iron_ingot, Character.valueOf('C'), Blocks.chest);
		this.addRecipe(new ItemStack(Items.armor_stand, 1),
				"///", " / ", "/_/", Character.valueOf('/'), Items.stick, Character.valueOf('_'),
