        ...
        Collections.sort(
            ...
            new Comparator<IRecipe>() {
                public int compare(IRecipe parIRecipe, IRecipe parIRecipe2) {
                    return parIRecipe instanceof ShapelessRecipes && parIRecipe2 instanceof ShapedRecipes ? 1 : (parIRecipe2 instanceof ShapelessRecipes && parIRecipe instanceof ShapedRecipes ? -1 : (parIRecipe2.getRecipeSize() < parIRecipe.getRecipeSize() ? -1 : (parIRecipe2.getRecipeSize() > parIRecipe.getRecipeSize() ? 1 : 0)));
                }
            }
        );
    }
