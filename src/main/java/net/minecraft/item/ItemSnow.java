        ...
        if (itemstack.stackSize == 0) {
            ...
            if (block == this.block) {
                ...
                if (i <= 7) {
                    ...
                    if (axisalignedbb != null && world.checkNoEntityCollision(axisalignedbb) && world.setBlockState(blockpos1, iblockstate1, 2)) {
                        world.playSoundEffect((double) ((float) blockpos1.getX() + 0.5F), (double) ((float) blockpos1.getY() + 0.5F), (double) ((float) blockpos1.getZ() + 0.5F), this.block.stepSound.getPlaceSound(), (this.block.stepSound.getVolume() + 1.0F) / 2.0F, this.block.stepSound.getFrequency() * 0.8F);
                        --itemstack.stackSize;
                        return true;
                    }
                }
