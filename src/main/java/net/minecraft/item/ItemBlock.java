...
public class ItemBlock extends Item {
    ...
    public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, BlockPos blockpos, EnumFacing enumfacing, float f, float f1, float f2) {
        ...
        if (itemstack.stackSize == 0) {
            ...
            IBlockState iblockstate1 = this.block.onBlockPlaced(world, blockpos, enumfacing, f, f1, f2, i, entityplayer);
            if (world.setBlockState(blockpos, iblockstate1, 3)) {
                ...
                world.playSoundEffect((double) ((float) blockpos.getX() + 0.5F), (double) ((float) blockpos.getY() + 0.5F), (double) ((float) blockpos.getZ() + 0.5F), this.block.stepSound.getPlaceSound(), (this.block.stepSound.getVolume() + 1.0F) / 2.0F, this.block.stepSound.getFrequency() * 0.8F);
                --itemstack.stackSize;
            }
    ...
    public boolean canPlaceBlockOnSide(World world, BlockPos blockpos, EnumFacing enumfacing, EntityPlayer var4, ItemStack itemstack) {
