...
public class Block {
	...
	public static void registerBlocks() {
		...
		registerBlock(9, "water", (new BlockStaticLiquid(Material.water)).setHardness(100.0F)
				.setLightOpacity(3).setUnlocalizedName("water").disableStats());
		...
		registerBlock(11, "lava", (new BlockStaticLiquid(Material.lava)).setHardness(100.0F)
				.setLightLevel(1.0F).setUnlocalizedName("lava").disableStats());
		...
		registerBlock(42, "iron_block",
				(new Block(Material.iron, MapColor.ironColor)).setHardness(5.0F).setResistance(10.0F)
						...
						.setCreativeTab(CreativeTabs.tabBlock));
		registerBlock(43, "double_stone_slab", (new BlockDoubleStoneSlab()).setHardness(2.0F)
		...
		registerBlock(51, "fire", (new BlockFire()).setHardness(0.0F).setLightLevel(1.0F)
		...
		registerBlock(55, "redstone_wire", (new BlockRedstoneWire()).setHardness(0.0F)
		...
		registerBlock(63, "standing_sign", (new BlockStandingSign()).setHardness(1.0F)
				.setStepSound(soundTypeWood).setUnlocalizedName("sign").disableStats());
		registerBlock(64, "wooden_door", (new BlockDoor(Material.wood)).setHardness(3.0F)
		...
		registerBlock(71, "iron_door", (new BlockDoor(Material.iron)).setHardness(5.0F)
		...
		registerBlock(79, "ice", (new BlockIce()).setHardness(0.5F).setLightOpacity(3)
		...
		registerBlock(96, "trapdoor", (new BlockTrapDoor(Material.wood)).setHardness(3.0F)
		...
		registerBlock(100, "red_mushroom_block",
				(new BlockHugeMushroom(Material.wood, MapColor.redColor, block4)).setHardness(0.2F)
						.setStepSound(soundTypeWood).setUnlocalizedName("mushroom"));
		registerBlock(101, "iron_bars", (new BlockPane(Material.iron, true)).setHardness(5.0F)
		...
		registerBlock(104, "pumpkin_stem", (new BlockStem(block7)).setHardness(0.0F)
		...
		registerBlock(116, "enchanting_table", (new BlockEnchantmentTable()).setHardness(5.0F)
		...
		registerBlock(125, "double_wooden_slab", (new BlockDoubleWoodSlab()).setHardness(2.0F)
		...
		registerBlock(137, "command_block", (new BlockCommandBlock()).setBlockUnbreakable()
		...
		registerBlock(153, "quartz_ore", (new BlockOre(MapColor.netherrackColor)).setHardness(3.0F)
		...
		registerBlock(181, "double_stone_slab2", (new BlockDoubleStoneSlabNew()).setHardness(2.0F)
		...
		registerBlock(193, "spruce_door", (new BlockDoor(Material.wood)).setHardness(3.0F)
				.setStepSound(soundTypeWood).setUnlocalizedName("doorSpruce").disableStats());
		registerBlock(194, "birch_door", (new BlockDoor(Material.wood)).setHardness(3.0F)
				.setStepSound(soundTypeWood).setUnlocalizedName("doorBirch").disableStats());
		registerBlock(195, "jungle_door", (new BlockDoor(Material.wood)).setHardness(3.0F)
				.setStepSound(soundTypeWood).setUnlocalizedName("doorJungle").disableStats());
		registerBlock(196, "acacia_door", (new BlockDoor(Material.wood)).setHardness(3.0F)
	...
	public boolean shouldSideBeRendered(IBlockAccess iblockaccess, BlockPos blockpos, EnumFacing enumfacing) {
		return enumfacing == EnumFacing.DOWN && this.minY > 0.0D || (enumfacing == EnumFacing.UP && this.maxY < 1.0D || (enumfacing == EnumFacing.NORTH && this.minZ > 0.0D || (enumfacing == EnumFacing.SOUTH && this.maxZ < 1.0D || (enumfacing == EnumFacing.WEST && this.minX > 0.0D || (enumfacing == EnumFacing.EAST && this.maxX < 1.0D || !iblockaccess.getBlockState(blockpos).getBlock()
				.isOpaqueCube())))));
	}
	...
	public MovingObjectPosition collisionRayTrace(World world, BlockPos blockpos, Vec3 vec3, Vec3 vec31) {
		...
		vec31 = vec31.addVector(-blockpos.getX(), -blockpos.getY(), -blockpos.getZ());
		...
		if (vec38 == null) {
			...
			return new MovingObjectPosition(
					vec38.addVector(blockpos.getX(), blockpos.getY(), blockpos.getZ()),
					enumfacing, blockpos);
		}
	}
