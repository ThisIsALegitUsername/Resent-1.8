...
public class Block {
    ...
    public MovingObjectPosition collisionRayTrace(World world, BlockPos blockpos, Vec3 vec3, Vec3 vec31) {
        ...
        if (vec38 == null) {
            ...
            return new MovingObjectPosition(vec38.addVector((double) blockpos.getX(), (double) blockpos.getY(), (double) blockpos.getZ()), enumfacing, blockpos);
        }
    }
     ...
     */
    public IBlockState onBlockPlaced(World var1, BlockPos var2, EnumFacing var3, float var4, float var5, float var6, int i, EntityLivingBase var8) {
    ...
    public void harvestBlock(World world, EntityPlayer entityplayer, BlockPos blockpos, IBlockState iblockstate, TileEntity var5) {
