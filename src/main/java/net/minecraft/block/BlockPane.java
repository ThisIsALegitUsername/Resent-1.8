...
public class BlockPane extends Block {
    ...
    public IBlockState getActualState(IBlockState iblockstate, IBlockAccess iblockaccess, BlockPos blockpos) {
        return iblockstate
            .withProperty(NORTH, Boolean.valueOf(this.canPaneConnectToBlock(iblockaccess.getBlockState(blockpos.north()).getBlock())))
            .withProperty(SOUTH, Boolean.valueOf(this.canPaneConnectToBlock(iblockaccess.getBlockState(blockpos.south()).getBlock())))
            .withProperty(WEST, Boolean.valueOf(this.canPaneConnectToBlock(iblockaccess.getBlockState(blockpos.west()).getBlock())))
            .withProperty(EAST, Boolean.valueOf(this.canPaneConnectToBlock(iblockaccess.getBlockState(blockpos.east()).getBlock())));
    }
