...
public class BlockTripWireHook extends Block {
    ...
    public IBlockState getActualState(IBlockState iblockstate, IBlockAccess iblockaccess, BlockPos blockpos) {
        return iblockstate.withProperty(SUSPENDED, Boolean.valueOf(!World.doesBlockHaveSolidTopSurface(iblockaccess, blockpos.down())));
    }
    ...
    public void func_176260_a(World worldIn, BlockPos pos, IBlockState hookState, boolean parFlag, boolean parFlag2, int parInt1, IBlockState parIBlockState2) {
    ...
    private void func_180694_a(World worldIn, BlockPos pos, boolean parFlag, boolean parFlag2, boolean parFlag3, boolean parFlag4) {
    ...
    public void breakBlock(World world, BlockPos blockpos, IBlockState iblockstate) {
        ...
        if (flag1) {
            ...
            world.notifyNeighborsOfStateChange(blockpos.offset(((EnumFacing) iblockstate.getValue(FACING)).getOpposite()), this);
        }
