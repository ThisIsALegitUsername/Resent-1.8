...
public class BlockRailPowered extends BlockRailBase {
            ...
            PropertyEnum.create(
                ...
                new Predicate<BlockRailBase.EnumRailDirection>() {
                    public boolean apply(BlockRailBase.EnumRailDirection blockrailbase$enumraildirection) {
                        return blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.NORTH_EAST && blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.NORTH_WEST && blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.SOUTH_EAST && blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.SOUTH_WEST;
                    }
                }
            );
    }
    ...
    protected boolean func_176566_a(World worldIn, BlockPos pos, IBlockState state, boolean parFlag, int parInt1) {
        if (parInt1 >= 8) {
            ...
            return this.func_176567_a(worldIn, new BlockPos(i, j, k), parFlag, parInt1, blockrailbase$enumraildirection) ? true : flag && this.func_176567_a(worldIn, new BlockPos(i, j - 1, k), parFlag, parInt1, blockrailbase$enumraildirection);
        }
    }

    protected boolean func_176567_a(World worldIn, BlockPos distance, boolean parFlag, int parInt1, BlockRailBase.EnumRailDirection parEnumRailDirection) {
        ...
        if (iblockstate.getBlock() != this) {
            ...
            return parEnumRailDirection != BlockRailBase.EnumRailDirection.EAST_WEST || blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.NORTH_SOUTH && blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.ASCENDING_NORTH && blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.ASCENDING_SOUTH
                ? (
                    parEnumRailDirection != BlockRailBase.EnumRailDirection.NORTH_SOUTH || blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.EAST_WEST && blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.ASCENDING_EAST && blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.ASCENDING_WEST
                        ? (((Boolean) iblockstate.getValue(POWERED)).booleanValue() ? (worldIn.isBlockPowered(distance) ? true : this.func_176566_a(worldIn, distance, iblockstate, parFlag, parInt1 + 1)) : false)
                        : false
                )
                : false;
        }
    ...
    protected void onNeighborChangedInternal(World world, BlockPos blockpos, IBlockState iblockstate, Block var4) {
        ...
        boolean flag1 = world.isBlockPowered(blockpos) || this.func_176566_a(world, blockpos, iblockstate, true, 0) || this.func_176566_a(world, blockpos, iblockstate, false, 0);
        if (flag1 != flag) {
