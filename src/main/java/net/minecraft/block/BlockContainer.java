...
public abstract class BlockContainer extends Block implements ITileEntityProvider {
    ...
    protected boolean func_181087_e(World parWorld, BlockPos parBlockPos) {
        return this.func_181086_a(parWorld, parBlockPos, EnumFacing.NORTH) || this.func_181086_a(parWorld, parBlockPos, EnumFacing.SOUTH) || this.func_181086_a(parWorld, parBlockPos, EnumFacing.WEST) || this.func_181086_a(parWorld, parBlockPos, EnumFacing.EAST);
    }
