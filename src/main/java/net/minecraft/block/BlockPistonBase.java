...
public class BlockPistonBase extends Block {
    ...
    public void onBlockPlacedBy(World world, BlockPos blockpos, IBlockState iblockstate, EntityLivingBase entitylivingbase, ItemStack var5) {
        world.setBlockState(blockpos, iblockstate.withProperty(FACING, getFacingFromEntity(world, blockpos, entitylivingbase)), 2);
    }
     ...
     */
    public IBlockState onBlockPlaced(World world, BlockPos blockpos, EnumFacing var3, float var4, float var5, float var6, int var7, EntityLivingBase entitylivingbase) {
        return this.getDefaultState().withProperty(FACING, getFacingFromEntity(world, blockpos, entitylivingbase)).withProperty(EXTENDED, Boolean.valueOf(false));
    }
    ...
    public boolean onBlockEventReceived(World world, BlockPos blockpos, IBlockState iblockstate, int i, int j) {
        ...
        if (i == 0) {
            ...
            world.playSoundEffect((double) blockpos.getX() + 0.5D, (double) blockpos.getY() + 0.5D, (double) blockpos.getZ() + 0.5D, "tile.piston.out", 0.5F, world.rand.nextFloat() * 0.25F + 0.6F);
        } else if (i == 1) {
            ...
            world.setTileEntity(blockpos, BlockPistonMoving.newTileEntity(this.getStateFromMeta(j), enumfacing, false, true));
            if (this.isSticky) {
                BlockPos blockpos1 = blockpos.add(enumfacing.getFrontOffsetX() * 2, enumfacing.getFrontOffsetY() * 2, enumfacing.getFrontOffsetZ() * 2);
                ...
                if (!flag1 && block.getMaterial() != Material.air && canPush(block, world, blockpos1, enumfacing.getOpposite(), false) && (block.getMobilityFlag() == 0 || block == Blocks.piston || block == Blocks.sticky_piston)) {
            ...
            world.playSoundEffect((double) blockpos.getX() + 0.5D, (double) blockpos.getY() + 0.5D, (double) blockpos.getZ() + 0.5D, "tile.piston.in", 0.5F, world.rand.nextFloat() * 0.15F + 0.6F);
        }
