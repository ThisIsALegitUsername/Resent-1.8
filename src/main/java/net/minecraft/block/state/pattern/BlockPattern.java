...
public class BlockPattern {
     ...
     * co-ordinates.
     */
    private BlockPattern.PatternHelper checkPatternAt(BlockPos pos, EnumFacing finger, EnumFacing thumb, EaglerLoadingCache<BlockPos, BlockWorldState> lcache) {
    ...
    public static class PatternHelper {
        ...
        public PatternHelper(BlockPos parBlockPos, EnumFacing parEnumFacing, EnumFacing parEnumFacing2, EaglerLoadingCache<BlockPos, BlockWorldState> parLoadingCache, int parInt1, int parInt2, int parInt3) {
        ...
        public BlockWorldState translateOffset(int palmOffset, int thumbOffset, int fingerOffset) {
            return (BlockWorldState) this.lcache.get(BlockPattern.translateOffset(this.pos, this.getFinger(), this.getThumb(), palmOffset, thumbOffset, fingerOffset));
        }
