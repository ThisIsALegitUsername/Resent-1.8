...
public abstract class BlockButton extends Block {
    ...
    protected static boolean func_181088_a(World parWorld, BlockPos parBlockPos, EnumFacing parEnumFacing) {
        ...
        return parEnumFacing == EnumFacing.DOWN ? World.doesBlockHaveSolidTopSurface(parWorld, blockpos) : parWorld.getBlockState(blockpos).getBlock().isNormalCube();
    }
    ...
    public IBlockState onBlockPlaced(World world, BlockPos blockpos, EnumFacing enumfacing, float var4, float var5, float var6, int var7, EntityLivingBase var8) {
        return func_181088_a(world, blockpos, enumfacing.getOpposite()) ? this.getDefaultState().withProperty(FACING, enumfacing).withProperty(POWERED, Boolean.valueOf(false)) : this.getDefaultState().withProperty(FACING, EnumFacing.DOWN).withProperty(POWERED, Boolean.valueOf(false));
    }
    ...
    public void onNeighborBlockChange(World world, BlockPos blockpos, IBlockState iblockstate, Block var4) {
        if (this.checkForDrop(world, blockpos, iblockstate) && !func_181088_a(world, blockpos, ((EnumFacing) iblockstate.getValue(FACING)).getOpposite())) {
    ...
    public boolean onBlockActivated(World world, BlockPos blockpos, IBlockState iblockstate, EntityPlayer var4, EnumFacing var5, float var6, float var7, float var8) {
        if (((Boolean) iblockstate.getValue(POWERED)).booleanValue()) {
            ...
            world.playSoundEffect((double) blockpos.getX() + 0.5D, (double) blockpos.getY() + 0.5D, (double) blockpos.getZ() + 0.5D, "random.click", 0.3F, 0.6F);
    ...
    public int getStrongPower(IBlockAccess var1, BlockPos var2, IBlockState iblockstate, EnumFacing enumfacing) {
        return !((Boolean) iblockstate.getValue(POWERED)).booleanValue() ? 0 : (iblockstate.getValue(FACING) == enumfacing ? 15 : 0);
    }
    ...
    public IBlockState getStateFromMeta(int i) {
        ...
        return this.getDefaultState().withProperty(FACING, enumfacing).withProperty(POWERED, Boolean.valueOf((i & 8) > 0));
    }
