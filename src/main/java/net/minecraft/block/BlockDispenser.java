...
public class BlockDispenser extends BlockContainer {
    ...
    public IBlockState onBlockPlaced(World world, BlockPos blockpos, EnumFacing var3, float var4, float var5, float var6, int var7, EntityLivingBase entitylivingbase) {
        return this.getDefaultState().withProperty(FACING, BlockPistonBase.getFacingFromEntity(world, blockpos, entitylivingbase)).withProperty(TRIGGERED, Boolean.valueOf(false));
    }
    ...
    public IBlockState getStateFromMeta(int i) {
        return this.getDefaultState().withProperty(FACING, getFacing(i)).withProperty(TRIGGERED, Boolean.valueOf((i & 8) > 0));
    }
