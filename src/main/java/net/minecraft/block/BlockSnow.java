...
public class BlockSnow extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBox(World var1, BlockPos blockpos, IBlockState iblockstate) {
        ...
        float f = 0.125F;
        return new AxisAlignedBB((double) blockpos.getX() + this.minX, (double) blockpos.getY() + this.minY, (double) blockpos.getZ() + this.minZ, (double) blockpos.getX() + this.maxX, (double) ((float) blockpos.getY() + (float) i * f), (double) blockpos.getZ() + this.maxZ);
    }
