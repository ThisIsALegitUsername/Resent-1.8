...
public class BlockTripWire extends Block {
    ...
    public IBlockState getActualState(IBlockState iblockstate, IBlockAccess iblockaccess, BlockPos blockpos) {
        return iblockstate
            .withProperty(NORTH, Boolean.valueOf(isConnectedTo(iblockaccess, blockpos, iblockstate, EnumFacing.NORTH)))
            .withProperty(EAST, Boolean.valueOf(isConnectedTo(iblockaccess, blockpos, iblockstate, EnumFacing.EAST)))
            .withProperty(SOUTH, Boolean.valueOf(isConnectedTo(iblockaccess, blockpos, iblockstate, EnumFacing.SOUTH)))
            .withProperty(WEST, Boolean.valueOf(isConnectedTo(iblockaccess, blockpos, iblockstate, EnumFacing.WEST)));
    }
    ...
    public void onBlockAdded(World world, BlockPos blockpos, IBlockState iblockstate) {
        iblockstate = iblockstate.withProperty(SUSPENDED, Boolean.valueOf(!World.doesBlockHaveSolidTopSurface(world, blockpos.down())));
    ...
    public IBlockState getStateFromMeta(int i) {
        return this.getDefaultState().withProperty(POWERED, Boolean.valueOf((i & 1) > 0)).withProperty(SUSPENDED, Boolean.valueOf((i & 2) > 0)).withProperty(ATTACHED, Boolean.valueOf((i & 4) > 0)).withProperty(DISARMED, Boolean.valueOf((i & 8) > 0));
    }
