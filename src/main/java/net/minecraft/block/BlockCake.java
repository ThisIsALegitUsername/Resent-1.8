...
public class BlockCake extends Block {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess iblockaccess, BlockPos blockpos) {
        float f = 0.0625F;
        float f1 = (float) (1 + ((Integer) iblockaccess.getBlockState(blockpos).getValue(BITES)).intValue() * 2) / 16.0F;
        float f2 = 0.5F;
    ...
    public AxisAlignedBB getCollisionBoundingBox(World var1, BlockPos blockpos, IBlockState iblockstate) {
        ...
        float f2 = 0.5F;
        return new AxisAlignedBB((double) ((float) blockpos.getX() + f1), (double) blockpos.getY(), (double) ((float) blockpos.getZ() + f), (double) ((float) (blockpos.getX() + 1) - f), (double) ((float) blockpos.getY() + f2), (double) ((float) (blockpos.getZ() + 1) - f));
    }
