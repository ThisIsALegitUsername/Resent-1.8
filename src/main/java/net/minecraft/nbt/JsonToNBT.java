...
public class JsonToNBT {
    ...
    static JsonToNBT.Any func_150316_a(String parString1, String parString2) throws NBTException {
        ...
        if (parString2.startsWith("{")) {
            ...
            String s1;
            for (jsontonbt$compound = new JsonToNBT.Compound(parString1); parString2.length() > 0; parString2 = parString2.substring(s1.length() + 1)) {
            ...
            String s;
            for (jsontonbt$list = new JsonToNBT.List(parString1); parString2.length() > 0; parString2 = parString2.substring(s.length() + 1)) {
