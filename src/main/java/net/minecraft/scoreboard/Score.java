...
public class Score {
    ...
    public static final Comparator<Score> scoreComparator = new Comparator<Score>() {
        public int compare(Score score, Score score1) {
            return score.getScorePoints() > score1.getScorePoints() ? 1 : (score.getScorePoints() < score1.getScorePoints() ? -1 : score1.getPlayerName().compareToIgnoreCase(score.getPlayerName()));
        }
    };
