...
public class S38PacketPlayerListItem implements Packet<INetHandlerPlayClient> {
    ...
    public void readPacketData(PacketBuffer parPacketBuffer) throws IOException {
        this.action = (S38PacketPlayerListItem.Action) parPacketBuffer.readEnumValue(S38PacketPlayerListItem.Action.class);
                ...
                case ADD_PLAYER:
                    ...
                    for (; i1 < l; ++i1) {
                        ...
                        if (parPacketBuffer.readBoolean()) {
                            gameprofile.getProperties().put(s, new Property(s, s1, parPacketBuffer.readStringFromBuffer(32767)));
                        } else {
