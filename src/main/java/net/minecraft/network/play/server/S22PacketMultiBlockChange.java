...
public class S22PacketMultiBlockChange implements Packet<INetHandlerPlayClient> {
    ...
    public void readPacketData(PacketBuffer parPacketBuffer) throws IOException {
        ...
        for (int i = 0; i < this.changedBlocks.length; ++i) {
            this.changedBlocks[i] = new S22PacketMultiBlockChange.BlockUpdateData(parPacketBuffer.readShort(), (IBlockState) Block.BLOCK_STATE_IDS.getByValue(parPacketBuffer.readVarIntFromBuffer()));
        }
    }
    ...
    public void writePacketData(PacketBuffer parPacketBuffer) throws IOException {
        ...
        for (S22PacketMultiBlockChange.BlockUpdateData s22packetmultiblockchange$blockupdatedata : this.changedBlocks) {
            ...
            parPacketBuffer.writeVarIntToBuffer(Block.BLOCK_STATE_IDS.get(s22packetmultiblockchange$blockupdatedata.getBlockState()));
        }
    }
