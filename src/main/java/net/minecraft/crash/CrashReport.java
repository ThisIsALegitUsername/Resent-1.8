...
public class CrashReport {
    ...
    public void getSectionsInStringBuilder(StringBuilder builder) {
        if ((this.stacktrace == null || this.stacktrace.length <= 0) && this.crashReportSections.size() > 0) {
            this.stacktrace = (String[]) ArrayUtils.subarray(((CrashReportCategory) this.crashReportSections.get(0)).getStackTrace(), 0, 1);
        }
    ...
    public String getCauseStackTraceOrString() {
        ...
        if ((this.cause.getMessage() == null || this.cause.getMessage().length() == 0) && ((this.cause instanceof NullPointerException) || (this.cause instanceof StackOverflowError) || (this.cause instanceof OutOfMemoryError))) {
