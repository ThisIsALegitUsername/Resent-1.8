...
public class CrashReportCategory {
    ...
    public static String getCoordinateInfo(double x, double y, double z) {
        return HString.format("%.2f,%.2f,%.2f - %s", new Object[] { Double.valueOf(x), Double.valueOf(y), Double.valueOf(z), getCoordinateInfo(new BlockPos(x, y, z)) });
    }
    ...
    public static String getCoordinateInfo(BlockPos pos) {
        ...
        try {
            stringbuilder.append(HString.format("World: (%d,%d,%d)", new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k) }));
        ...
        try {
            ...
            int k2 = (l + 1 << 4) - 1;
            int l2 = (i1 + 1 << 4) - 1;
            stringbuilder.append(HString.format("Chunk: (at %d,%d,%d in %d,%d; contains blocks %d,0,%d to %d,255,%d)", new Object[] { Integer.valueOf(j1), Integer.valueOf(k1), Integer.valueOf(l1), Integer.valueOf(l), Integer.valueOf(i1), Integer.valueOf(i2), Integer.valueOf(j2), Integer.valueOf(k2), Integer.valueOf(l2) }));
        ...
        try {
            ...
            int j5 = (j3 + 1 << 9) - 1;
            int i3 = (k3 + 1 << 9) - 1;
            stringbuilder.append(HString.format("Region: (%d,%d; contains chunks %d,%d to %d,%d, blocks %d,0,%d to %d,255,%d)", new Object[] { Integer.valueOf(j3), Integer.valueOf(k3), Integer.valueOf(l3), Integer.valueOf(i4), Integer.valueOf(j4), Integer.valueOf(k4), Integer.valueOf(l4), Integer.valueOf(i5), Integer.valueOf(j5), Integer.valueOf(i3) }));
        ...
        category.addCrashSectionCallable(
            ...
            new Callable<String>() {
                public String call() throws Exception {
                    try {
                        return HString.format("ID #%d (%s // %s)", new Object[] { Integer.valueOf(i), blockIn.getUnlocalizedName(), blockIn.getClass().getName() });
            ...
            new Callable<String>() {
                public String call() throws Exception {
                    if (blockData < 0) {
                        ...
                        String s = HString.format("%4s", new Object[] { Integer.toBinaryString(blockData) }).replace(" ", "0");
