...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
    ...
    public MerchantRecipe canRecipeBeUsed(ItemStack parItemStack, ItemStack parItemStack2, int parInt1) {
        if (parInt1 > 0 && parInt1 < this.size()) {
            ...
            return (
                    !this.func_181078_a(parItemStack, merchantrecipe1.getItemToBuy()) ||
                    (parItemStack2 != null || merchantrecipe1.hasSecondItemToBuy()) &&
                    (!merchantrecipe1.hasSecondItemToBuy() || !this.func_181078_a(parItemStack2, merchantrecipe1.getSecondItemToBuy())) ||
                    parItemStack.stackSize < merchantrecipe1.getItemToBuy().stackSize ||
                    merchantrecipe1.hasSecondItemToBuy() &&
                    parItemStack2.stackSize < merchantrecipe1.getSecondItemToBuy().stackSize
                )
                ? null
                : merchantrecipe1;
        } else {
            for (int i = 0; i < this.size(); ++i) {
                ...
                if (
                    this.func_181078_a(parItemStack, merchantrecipe.getItemToBuy()) &&
                    parItemStack.stackSize >= merchantrecipe.getItemToBuy().stackSize &&
                    (!merchantrecipe.hasSecondItemToBuy() && parItemStack2 == null || merchantrecipe.hasSecondItemToBuy() && this.func_181078_a(parItemStack2, merchantrecipe.getSecondItemToBuy()) && parItemStack2.stackSize >= merchantrecipe.getSecondItemToBuy().stackSize)
                ) {
    ...
    private boolean func_181078_a(ItemStack parItemStack, ItemStack parItemStack2) {
        return ItemStack.areItemsEqual(parItemStack, parItemStack2) && (!parItemStack2.hasTagCompound() || parItemStack.hasTagCompound() && NBTUtil.func_181123_a(parItemStack2.getTagCompound(), parItemStack.getTagCompound(), false));
    }
