...
public class EntitySheep extends EntityAnimal {
     ...
     * sheep.
     */
    private final InventoryCrafting inventoryCrafting = new InventoryCrafting(
        new Container() {
    ...
    public float getHeadRotationPointY(float parFloat1) {
        return this.sheepTimer <= 0 ? 0.0F : (this.sheepTimer >= 4 && this.sheepTimer <= 36 ? 1.0F : (this.sheepTimer < 4 ? ((float) this.sheepTimer - parFloat1) / 4.0F : -((float) (this.sheepTimer - 40) - parFloat1) / 4.0F));
    }
