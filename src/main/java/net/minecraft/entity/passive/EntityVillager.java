...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc {
    ...
    static class ItemAndEmeraldToItem implements EntityVillager.ITradeList {
        ...
        public ItemAndEmeraldToItem(Item parItem, EntityVillager.PriceInfo parPriceInfo, Item parItem2, EntityVillager.PriceInfo parPriceInfo2) {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList merchantrecipelist, EaglercraftRandom random) {
            ...
            merchantrecipelist.add(new MerchantRecipe(new ItemStack(this.field_179411_a.getItem(), i, this.field_179411_a.getMetadata()), new ItemStack(Items.emerald), new ItemStack(this.field_179410_c.getItem(), j, this.field_179410_c.getMetadata())));
        }
    }
