...
public class EntityHorse extends EntityAnimal implements IInvBasic {
    ...
    public EntityAgeable createChild(EntityAgeable entityageable) {
        ...
        double d1 = this.getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue() + entityageable.getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue() + (double) this.getModifiedMaxHealth();
        ...
        double d0 = this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).getBaseValue() + entityageable.getEntityAttribute(SharedMonsterAttributes.movementSpeed).getBaseValue() + this.getModifiedMovementSpeed();
    ...
    public static boolean isArmorItem(Item parItem) {
        return parItem == Items.iron_horse_armor || parItem == Items.golden_horse_armor || parItem == Items.diamond_horse_armor;
    }
