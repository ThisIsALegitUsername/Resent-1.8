...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public EntityArrow(World worldIn, EntityLivingBase shooter, EntityLivingBase parEntityLivingBase, float parFloat1, float parFloat2) {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        ...
        double d1 = parEntityLivingBase.getEntityBoundingBox().minY + (double) (parEntityLivingBase.height / 3.0F) - this.posY;
