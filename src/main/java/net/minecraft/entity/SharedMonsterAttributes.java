...
public class SharedMonsterAttributes {
    ...
    public static void func_151475_a(BaseAttributeMap parBaseAttributeMap, NBTTagList parNBTTagList) {
        for (int i = 0; i < parNBTTagList.tagCount(); ++i) {
            ...
            IAttributeInstance iattributeinstance = parBaseAttributeMap.getAttributeInstanceByName(nbttagcompound.getString("Name"));
    ...
    private static void applyModifiersToAttributeInstance(IAttributeInstance parIAttributeInstance, NBTTagCompound parNBTTagCompound) {
    ...
    public static AttributeModifier readAttributeModifierFromNBT(NBTTagCompound parNBTTagCompound) {
        EaglercraftUUID uuid = new EaglercraftUUID(parNBTTagCompound.getLong("UUIDMost"), parNBTTagCompound.getLong("UUIDLeast"));

        try {
            return new AttributeModifier(uuid, parNBTTagCompound.getString("Name"), parNBTTagCompound.getDouble("Amount"), parNBTTagCompound.getInteger("Operation"));
