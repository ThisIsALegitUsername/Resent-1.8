...
public class EntityList {
    ...
    private static final Map<String, EntityConstructor<? extends Entity>> stringToConstructorMapping = Maps.newHashMap();
     ...
     */
    private static void addMapping(Class<? extends Entity> entityClass, EntityConstructor<? extends Entity> entityConstructor, String entityName, int id) {
     ...
     * representation and an ID
     */
    private static void addMapping(Class<? extends Entity> entityClass, EntityConstructor<? extends Entity> entityConstructor, String entityName, int entityID, int baseColor, int spotColor) {
    ...
    static {
        ...
        addMapping(EntityMinecartEmpty.class, w -> new EntityMinecartEmpty(w), EntityMinecart.EnumMinecartType.RIDEABLE.getName(), 42);
        addMapping(EntityMinecartChest.class, w -> new EntityMinecartChest(w), EntityMinecart.EnumMinecartType.CHEST.getName(), 43);
        addMapping(EntityMinecartFurnace.class, w -> new EntityMinecartFurnace(w), EntityMinecart.EnumMinecartType.FURNACE.getName(), 44);
        addMapping(EntityMinecartTNT.class, w -> new EntityMinecartTNT(w), EntityMinecart.EnumMinecartType.TNT.getName(), 45);
        addMapping(EntityMinecartHopper.class, w -> new EntityMinecartHopper(w), EntityMinecart.EnumMinecartType.HOPPER.getName(), 46);
        addMapping(EntityMinecartMobSpawner.class, w -> new EntityMinecartMobSpawner(w), EntityMinecart.EnumMinecartType.SPAWNER.getName(), 47);
        addMapping(EntityMinecartCommandBlock.class, w -> new EntityMinecartCommandBlock(w), EntityMinecart.EnumMinecartType.COMMAND_BLOCK.getName(), 40);
