...
public abstract class Entity {
    ...
    public void readFromNBT(NBTTagCompound tagCompund) {
        try {
            ...
            if (tagCompund.hasKey("UUIDMost", 4) && tagCompund.hasKey("UUIDLeast", 4)) {
                this.entityUniqueID = new EaglercraftUUID(tagCompund.getLong("UUIDMost"), tagCompund.getLong("UUIDLeast"));
    ...
    public String toString() {
        return HString.format("%s[\'%s\'/%d, l=\'%s\', x=%.2f, y=%.2f, z=%.2f]", new Object[] { this.getClass().getSimpleName(), this.getName(), Integer.valueOf(this.entityId), this.worldObj == null ? "~NULL~" : this.worldObj.getWorldInfo().getWorldName(), Double.valueOf(this.posX), Double.valueOf(this.posY), Double.valueOf(this.posZ) });
    }
    ...
    public void addEntityCrashInfo(CrashReportCategory category) {
        ...
        category.addCrashSection("Entity\'s Exact location", HString.format("%.2f, %.2f, %.2f", new Object[] { Double.valueOf(this.posX), Double.valueOf(this.posY), Double.valueOf(this.posZ) }));
        ...
        category.addCrashSection("Entity\'s Momentum", HString.format("%.2f, %.2f, %.2f", new Object[] { Double.valueOf(this.motionX), Double.valueOf(this.motionY), Double.valueOf(this.motionZ) }));
        category.addCrashSectionCallable(
            "Entity\'s Rider",
            new Callable<String>() {
                public String call() throws Exception {
