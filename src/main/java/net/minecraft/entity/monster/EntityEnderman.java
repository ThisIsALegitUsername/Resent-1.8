...
public class EntityEnderman extends EntityMob {
    ...
    private static final EaglercraftUUID attackingSpeedBoostModifierUUID = EaglercraftUUID.fromString("020E0DFB-87AE-4653-9556-831010E291A0");
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
        ...
        if (nbttagcompound.hasKey("carried", 8)) {
            iblockstate = Block.getBlockFromName(nbttagcompound.getString("carried")).getStateFromMeta(nbttagcompound.getShort("carriedData") & '\uffff');
        } else {
            iblockstate = Block.getBlockById(nbttagcompound.getShort("carried")).getStateFromMeta(nbttagcompound.getShort("carriedData") & '\uffff');
        }
    ...
    protected boolean teleportToEntity(Entity parEntity) {
        Vec3 vec3 = new Vec3(this.posX - parEntity.posX, this.getEntityBoundingBox().minY + (double) (this.height / 2.0F) - parEntity.posY + (double) parEntity.getEyeHeight(), this.posZ - parEntity.posZ);
        vec3 = vec3.normalize();
        double d0 = 16.0D;
