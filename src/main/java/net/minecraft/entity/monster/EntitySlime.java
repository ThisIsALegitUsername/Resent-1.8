...
public class EntitySlime extends EntityLiving implements IMob {
    ...
    protected void func_175451_e(EntityLivingBase parEntityLivingBase) {
        int i = this.getSlimeSize();
        if (this.canEntityBeSeen(parEntityLivingBase) && this.getDistanceSqToEntity(parEntityLivingBase) < 0.6D * (double) i * 0.6D * (double) i && parEntityLivingBase.attackEntityFrom(DamageSource.causeMobDamage(this), (float) this.getAttackStrength())) {
