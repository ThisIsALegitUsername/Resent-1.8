...
public class EntityFirework {
    ...
    public static class Factory implements IParticleFactory {
        ...
        public EntityFX getEntityFX(int var1, World world, double d0, double d1, double d2, double d3, double d4, double d5, int... var15) {
            EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(world, d0, d1, d2, d3, d4, d5, Minecraft.getMinecraft().effectRenderer);
    ...
    public static class OverlayFX extends EntityFX {
        ...
        public void renderParticle(WorldRenderer worldrenderer, Entity var2, float f, float f1, float f2, float f3, float f4, float f5) {
            ...
            int j = i >> 16 & '\uffff';
            int k = i & '\uffff';
            worldrenderer.pos((double) (f11 - f1 * f10 - f4 * f10), (double) (f12 - f2 * f10), (double) (f13 - f3 * f10 - f5 * f10)).tex(0.5D, 0.375D).color(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).lightmap(j, k).endVertex();
            worldrenderer.pos((double) (f11 - f1 * f10 + f4 * f10), (double) (f12 + f2 * f10), (double) (f13 - f3 * f10 + f5 * f10)).tex(0.5D, 0.125D).color(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).lightmap(j, k).endVertex();
            worldrenderer.pos((double) (f11 + f1 * f10 + f4 * f10), (double) (f12 + f2 * f10), (double) (f13 + f3 * f10 + f5 * f10)).tex(0.25D, 0.125D).color(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).lightmap(j, k).endVertex();
            worldrenderer.pos((double) (f11 + f1 * f10 - f4 * f10), (double) (f12 - f2 * f10), (double) (f13 + f3 * f10 - f5 * f10)).tex(0.25D, 0.375D).color(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).lightmap(j, k).endVertex();
        }
    ...
    public static class SparkFX extends EntityFX {
        ...
        public SparkFX(World parWorld, double parDouble1, double parDouble2, double parDouble3, double parDouble4, double parDouble5, double parDouble6, EffectRenderer parEffectRenderer) {
            super(parWorld, parDouble1, parDouble2, parDouble3);
    ...
    public static class StarterFX extends EntityFX {
        ...
        public StarterFX(World parWorld, double parDouble1, double parDouble2, double parDouble3, double parDouble4, double parDouble5, double parDouble6, EffectRenderer parEffectRenderer, NBTTagCompound parNBTTagCompound) {
        ...
        private void createParticle(double parDouble1, double parDouble2, double parDouble3, double parDouble4, double parDouble5, double parDouble6, int[] parArrayOfInt, int[] parArrayOfInt2, boolean parFlag, boolean parFlag2) {
            EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(this.worldObj, parDouble1, parDouble2, parDouble3, parDouble4, parDouble5, parDouble6, this.theEffectRenderer);
            entityfirework$sparkfx.setAlphaF(0.99F);
        ...
        private void createShaped(double speed, double[][] shape, int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn, boolean parFlag3) {
            double d0 = shape[0][0];
            double d1 = shape[0][1];
