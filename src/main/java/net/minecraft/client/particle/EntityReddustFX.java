...
public class EntityReddustFX extends EntityFX {
    ...
    protected EntityReddustFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float parFloat1, float parFloat2, float parFloat3) {
        this(worldIn, xCoordIn, yCoordIn, zCoordIn, 1.0F, parFloat1, parFloat2, parFloat3);
    }

    protected EntityReddustFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float parFloat1, float parFloat2, float parFloat3, float parFloat4) {
