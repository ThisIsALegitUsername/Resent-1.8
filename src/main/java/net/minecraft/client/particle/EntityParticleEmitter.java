...
public class EntityParticleEmitter extends EntityFX {
    ...
    public EntityParticleEmitter(World worldIn, Entity parEntity, EnumParticleTypes particleTypesIn) {
        super(worldIn, parEntity.posX, parEntity.getEntityBoundingBox().minY + (double) (parEntity.height / 2.0F), parEntity.posZ, parEntity.motionX, parEntity.motionY, parEntity.motionZ);
