...
public class EntitySpellParticleFX extends EntityFX {
    ...
    protected EntitySpellParticleFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double parDouble1, double parDouble2, double parDouble3) {
        super(worldIn, xCoordIn, yCoordIn, zCoordIn, 0.5D - RANDOM.nextDouble(), parDouble2, 0.5D - RANDOM.nextDouble());
