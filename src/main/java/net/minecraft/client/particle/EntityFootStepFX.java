...
public class EntityFootStepFX extends EntityFX {
     ...
     */
    public void renderParticle(WorldRenderer worldrenderer, Entity var2, float f, float var4, float var5, float var6, float var7, float var8) {
        ...
        worldrenderer.pos((double) (f4 - 0.125F), (double) f5, (double) (f6 + 0.125F)).tex(0.0D, 1.0D).color(f7, f7, f7, f2).endVertex();
        worldrenderer.pos((double) (f4 + 0.125F), (double) f5, (double) (f6 + 0.125F)).tex(1.0D, 1.0D).color(f7, f7, f7, f2).endVertex();
        worldrenderer.pos((double) (f4 + 0.125F), (double) f5, (double) (f6 - 0.125F)).tex(1.0D, 0.0D).color(f7, f7, f7, f2).endVertex();
        worldrenderer.pos((double) (f4 - 0.125F), (double) f5, (double) (f6 - 0.125F)).tex(0.0D, 0.0D).color(f7, f7, f7, f2).endVertex();
