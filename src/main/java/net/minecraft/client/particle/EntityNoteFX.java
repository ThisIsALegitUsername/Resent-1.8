...
public class EntityNoteFX extends EntityFX {
    ...
    protected EntityNoteFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double parDouble1, double parDouble2, double parDouble3) {
        this(worldIn, xCoordIn, yCoordIn, zCoordIn, parDouble1, parDouble2, parDouble3, 2.0F);
    }

    protected EntityNoteFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double parDouble1, double parDouble2, double parDouble3, float parFloat1) {
