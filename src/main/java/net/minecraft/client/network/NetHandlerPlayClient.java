...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (packetIn.getType() == 10) {
            ...
            object = new EntityLargeFireball(this.clientWorldController, d0, d1, d2, (double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            packetIn.func_149002_g(0);
        } else if (packetIn.getType() == 64) {
            object = new EntitySmallFireball(this.clientWorldController, d0, d1, d2, (double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            packetIn.func_149002_g(0);
        } else if (packetIn.getType() == 66) {
            object = new EntityWitherSkull(this.clientWorldController, d0, d1, d2, (double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            packetIn.func_149002_g(0);
            ...
            object = new EntityFallingBlock(this.clientWorldController, d0, d1, d2, Block.getStateById(packetIn.func_149009_m() & '\uffff'));
            packetIn.func_149002_g(0);
        }
        ...
        if (object != null) {
            ...
            if (packetIn.func_149009_m() > 0) {
                ...
                ((Entity) object).setVelocity((double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            }
        }
    }
    ...
    public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
        EntityXPOrb entityxporb = new EntityXPOrb(this.clientWorldController, (double) packetIn.getX() / 32.0D, (double) packetIn.getY() / 32.0D, (double) packetIn.getZ() / 32.0D, packetIn.getXPValue());
    ...
    public void handleChat(S02PacketChat packetIn) {
        if (packetIn.getType() == 2) {
            ...
            if (
                ...
                packetIn.getChatComponent().getUnformattedText().toLowerCase().contains("you lost the") &&
                AutoGG.onLose.getValue()
            ) {
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        ...
        if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData().getResourceMode() == ServerData.ServerResourceMode.ENABLED) {
            ...
            NetHandlerPlayClient.this.gameController.getResourcePackRepository()
