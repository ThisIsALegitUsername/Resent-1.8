...
public class ModelBakery {
	...
	private List<String> getVariantNames(Item parItem) {
        List list = this.variantNames.get(parItem);
		if (list == null) {
            list = Collections
                    .singletonList(Item.itemRegistry.getNameForObject(parItem).toString());
		}
	...
	private IBakedModel bakeModel(ModelBlock modelBlockIn, ModelRotation modelRotationIn, boolean uvLocked) {
        EaglerTextureAtlasSprite textureatlassprite = this.sprites
		...
		for (BlockPart blockpart : modelBlockIn.getElements()) {
			for (EnumFacing enumfacing : blockpart.mapFaces.keySet()) {
                ...
                EaglerTextureAtlasSprite textureatlassprite1 = this.sprites
	...
	private List<ResourceLocation> getParentPath(ResourceLocation parResourceLocation) {
        ArrayList arraylist = Lists.newArrayList(parResourceLocation);
