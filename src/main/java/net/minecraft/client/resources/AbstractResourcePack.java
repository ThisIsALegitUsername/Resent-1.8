...
public abstract class AbstractResourcePack implements IResourcePack {
    ...
    private static String locationToName(ResourceLocation location) {
        return HString.format("%s/%s/%s", new Object[] { "assets", location.getResourceDomain(), location.getResourcePath() });
    }
    ...
    protected void logNameNotLowercase(String parString1) {
        resourceLog.warn("ResourcePack: ignored non-lowercase namespace: %s in %s", new Object[] { parString1, this.resourcePackFile });
    }

    public <T extends IMetadataSection> T getPackMetadata(IMetadataSerializer parIMetadataSerializer, String parString1) throws IOException {
        try {
    ...
    static <T extends IMetadataSection> T readMetadata(IMetadataSerializer parIMetadataSerializer, InputStream parInputStream, String parString1) {
