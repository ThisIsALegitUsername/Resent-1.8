 ...
 *
 */
public class PackMetadataSectionSerializer extends BaseMetadataSectionSerializer<PackMetadataSection> implements JSONTypeSerializer<PackMetadataSection, JSONObject> {

    public PackMetadataSection deserialize(JSONObject jsonobject) throws JSONException {
        IChatComponent ichatcomponent = JSONTypeProvider.deserialize(jsonobject.get("description"), IChatComponent.class);
    ...
    public JSONObject serialize(PackMetadataSection packmetadatasection) {
        ...
        jsonobject.put("description", (JSONObject) JSONTypeProvider.serialize(packmetadatasection.getPackDescription()));
        return jsonobject;
    }
