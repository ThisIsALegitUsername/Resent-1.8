...
public class IMetadataSerializer {
    ...
    public <T extends IMetadataSection> T parseMetadataSection(String parString1, JSONObject parJsonObject) {
        if (parString1 == null) {
            ...
            throw new IllegalArgumentException("Invalid metadata for \'" + parString1 + "\' - expected object, found " + parJsonObject.get(parString1));
        } else {
            IMetadataSerializer.Registration imetadataserializer$registration = (IMetadataSerializer.Registration) this.metadataSectionSerializerRegistry.getObject(parString1);
            if (imetadataserializer$registration == null) {
                ...
                return (T) ((IMetadataSection) JSONTypeProvider.deserialize(parJsonObject.getJSONObject(parString1), imetadataserializer$registration.field_110500_b));
            }
        }
    }
