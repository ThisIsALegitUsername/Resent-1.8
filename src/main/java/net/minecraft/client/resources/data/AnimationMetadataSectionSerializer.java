 ...
 *
 */
public class AnimationMetadataSectionSerializer extends BaseMetadataSectionSerializer<AnimationMetadataSection> implements JSONTypeSerializer<AnimationMetadataSection, JSONObject> {
    ...
    public AnimationMetadataSection deserialize(JSONObject jsonobject) throws JSONException {
        ...
        if (jsonobject.has("frames")) {
            try {
                ...
                throw new JSONException("Invalid animation->frames: expected array, was " + jsonobject.get("frames"), classcastexception);
            }
        }
