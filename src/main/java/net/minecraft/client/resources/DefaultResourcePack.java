...
public class DefaultResourcePack implements IResourcePack {
    ...
    private InputStream getResourceStream(ResourceLocation location) {
        return EagRuntime.getResourceStream("/assets/" + location.getResourceDomain() + "/" + location.getResourcePath());
    }
    ...
    public <T extends IMetadataSection> T getPackMetadata(IMetadataSerializer parIMetadataSerializer, String parString1) throws IOException {
        try {
            return AbstractResourcePack.readMetadata(parIMetadataSerializer, EagRuntime.getResourceStream("pack.mcmeta"), parString1);
