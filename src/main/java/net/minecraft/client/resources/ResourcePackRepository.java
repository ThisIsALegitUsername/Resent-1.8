...
public class ResourcePackRepository {
    ...
    public ResourcePackRepository(IResourcePack rprDefaultResourcePackIn, IMetadataSerializer rprMetadataSerializerIn, GameSettings settings) {
        ...
        for (String file1 : SYS.getResourcePackNames()) {
            ...
            if (!this.repositoryEntriesAll.contains(resourcepackrepository$entry)) {
                try {
                    ...
                    logger.error("Failed to call \"updateResourcePack\" for resource pack \"{}\"", resourcepackrepository$entry.resourcePackFile);
                    logger.error(var6);
    ...
    public void downloadResourcePack(String s1, String s2, Consumer<Boolean> cb) {
        SYS.loadRemoteResourcePack(
            ...
            () -> {
                Minecraft.getMinecraft().loadingScreen.eaglerShow(I18n.format("resourcePack.load.loading"), "Server resource pack");
            }
        );
    }
    ...
    public class Entry {
        ...
        public boolean equals(Object object) {
            return this == object ? true : (object instanceof ResourcePackRepository.Entry ? this.toString().equals(object.toString()) : false);
        }
