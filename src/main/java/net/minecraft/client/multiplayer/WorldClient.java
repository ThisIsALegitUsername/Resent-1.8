...
public class WorldClient extends World {
    ...
    public WorldClient(NetHandlerPlayClient parNetHandlerPlayClient, WorldSettings parWorldSettings, int parInt1, EnumDifficulty parEnumDifficulty, Profiler parProfiler) {
        super(new SaveHandlerMP(), new WorldInfo(parWorldSettings, "MpServer"), WorldProvider.getProviderForDimension(parInt1), parProfiler, true);
    ...
    public void doPreChunk(int parInt1, int parInt2, boolean parFlag) {
        ...
        if (!parFlag) {
            this.markBlockRangeForRenderUpdate(parInt1 * 16, 0, parInt2 * 16, parInt1 * 16 + 15, 256, parInt2 * 16 + 15);
        }
    }
     ...
     */
    public void playSoundAtPos(BlockPos parBlockPos, String parString1, float parFloat1, float parFloat2, boolean parFlag) {
        this.playSound((double) parBlockPos.getX() + 0.5D, (double) parBlockPos.getY() + 0.5D, (double) parBlockPos.getZ() + 0.5D, parString1, parFloat1, parFloat2, parFlag);
    }
    ...
    public void playSound(double d0, double d1, double d2, String s, float f, float f1, boolean flag) {
        ...
        PositionedSoundRecord positionedsoundrecord = new PositionedSoundRecord(new ResourceLocation(s), f, f1, (float) d0, (float) d1, (float) d2);
        if (flag && d3 > 100.0D) {
    ...
    public void makeFireworks(double d0, double d1, double d2, double d3, double d4, double d5, NBTTagCompound nbttagcompound) {
        this.mc.effectRenderer.addEffect(new EntityFirework.StarterFX(this, d0, d1, d2, d3, d4, d5, this.mc.effectRenderer, nbttagcompound));
    }
