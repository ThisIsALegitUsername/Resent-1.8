...
public class PlayerControllerMP {
    ...
    public boolean func_178894_a(EntityPlayer parEntityPlayer, Entity parEntity, MovingObjectPosition parMovingObjectPosition) {
        this.syncCurrentPlayItem();
        Vec3 vec3 = new Vec3(parMovingObjectPosition.hitVec.xCoord - parEntity.posX, parMovingObjectPosition.hitVec.yCoord - parEntity.posY, parMovingObjectPosition.hitVec.zCoord - parEntity.posZ);
