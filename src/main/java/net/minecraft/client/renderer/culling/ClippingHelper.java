...
public class ClippingHelper {
    ...
    private double dot(float[] parArrayOfFloat, double parDouble1, double parDouble2, double parDouble3) {
        return (double) parArrayOfFloat[0] * parDouble1 + (double) parArrayOfFloat[1] * parDouble2 + (double) parArrayOfFloat[2] * parDouble3 + (double) parArrayOfFloat[3];
    }
    ...
    public boolean isBoxInFrustum(double parDouble1, double parDouble2, double parDouble3, double parDouble4, double parDouble5, double parDouble6) {
        for (int i = 0; i < 6; ++i) {
            ...
            if (
                this.dot(afloat, parDouble1, parDouble2, parDouble3) <= 0.0D &&
