...
public class Frustum implements ICamera {
     ...
     */
    public boolean isBoxInFrustum(double parDouble1, double parDouble2, double parDouble3, double parDouble4, double parDouble5, double parDouble6) {
        return this.clippingHelper.isBoxInFrustum(parDouble1 - this.xPosition, parDouble2 - this.yPosition, parDouble3 - this.zPosition, parDouble4 - this.xPosition, parDouble5 - this.yPosition, parDouble6 - this.zPosition);
    }
