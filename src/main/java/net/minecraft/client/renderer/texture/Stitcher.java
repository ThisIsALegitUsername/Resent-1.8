...
public class Stitcher {
    ...
    public void doStitch() {
        ...
        for (Stitcher.Holder stitcher$holder : astitcher$holder) {
            if (!this.allocateSlot(stitcher$holder)) {
                String s = HString.format("Unable to fit: %s - size: %dx%d - Maybe try a lowerresolution resourcepack?", new Object[] { stitcher$holder.getAtlasSprite().getIconName(), Integer.valueOf(stitcher$holder.getAtlasSprite().getIconWidth()), Integer.valueOf(stitcher$holder.getAtlasSprite().getIconHeight()) });
    ...
    public static class Holder implements Comparable<Stitcher.Holder> {
        ...
        public Holder(EaglerTextureAtlasSprite parTextureAtlasSprite, int parInt1) {
            ...
            this.rotated = Stitcher.getMipmapDimension(this.height, parInt1) > Stitcher.getMipmapDimension(this.width, parInt1);
        }
