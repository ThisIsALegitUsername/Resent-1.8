...
public class LayeredColorMaskTexture extends AbstractTexture {
    ...
    public LayeredColorMaskTexture(ResourceLocation textureLocationIn, List<String> parList, List<EnumDyeColor> parList2) {
    ...
    public void loadTexture(IResourceManager parIResourceManager) throws IOException {
        ...
        try {
            ImageData bufferedimage1 = TextureUtil.readBufferedImage(parIResourceManager.getResource(this.textureLocation).getInputStream());

            bufferedimage = new ImageData(bufferedimage1.width, bufferedimage1.height, false);
            bufferedimage.drawLayer(bufferedimage1, 0, 0, bufferedimage1.width, bufferedimage1.height, 0, 0, bufferedimage1.width, bufferedimage1.height);
                        ...
                        for (int k = 0; k < bufferedimage2.height; ++k) {
                            for (int l = 0; l < bufferedimage2.width; ++l) {
                                ...
                                if ((i1 & -16777216) != 0) {
                                    ...
                                    int l1 = MathHelper.func_180188_d(k1, ImageData.swapRB(mapcolor.colorValue)) & 16777215;
                                    bufferedimage2.pixels[k * bufferedimage2.width + l] = j1 | l1;
                                }
                            }
                        }

                        bufferedimage.drawLayer(bufferedimage2, 0, 0, bufferedimage2.width, bufferedimage2.height, 0, 0, bufferedimage2.width, bufferedimage2.height);
                    }
                }
            }
