...
public class TextureUtil {
    ...
    public static void uploadTextureMipmap(int[][] parArrayOfarray, int parInt1, int parInt2, int parInt3, int parInt4, boolean parFlag, boolean parFlag2) {
        for (int i = 0; i < parArrayOfarray.length; ++i) {
            int[] aint = parArrayOfarray[i];
            uploadTextureSub(i, aint, parInt1 >> i, parInt2 >> i, parInt3 >> i, parInt4 >> i, parFlag, parFlag2, parArrayOfarray.length > 1);
        }
    }

    private static void uploadTextureSub(int parInt1, int[] parArrayOfInt, int parInt2, int parInt3, int parInt4, int parInt5, boolean parFlag, boolean parFlag2, boolean parFlag3) {
        ...
        for (int j = 0; j < parInt2 * parInt3; j += parInt2 * l) {
            ...
            EaglercraftGPU.glTexSubImage2D(GL_TEXTURE_2D, parInt1, parInt4, parInt5 + k, parInt2, l, GL_RGBA, GL_UNSIGNED_BYTE, dataBuffer);
        }
    }

    public static int uploadTextureImageAllocate(int parInt1, ImageData parBufferedImage, boolean parFlag, boolean parFlag2) {
    ...
    public static void allocateTextureImpl(int parInt1, int parInt2, int parInt3, int parInt4) {
        ...
        for (int i = 0; i <= parInt2; ++i) {
            EaglercraftGPU.glTexImage2D(GL_TEXTURE_2D, i, GL_RGBA, parInt3 >> i, parInt4 >> i, 0, GL_RGBA, GL_UNSIGNED_BYTE, (IntBuffer) null);
        }
    }

    public static int uploadTextureImageSub(int textureId, ImageData parBufferedImage, int parInt2, int parInt3, boolean parFlag, boolean parFlag2) {
        bindTexture(textureId);
        uploadTextureImageSubImpl(parBufferedImage, parInt2, parInt3, parFlag, parFlag2);
        return textureId;
    }

    private static void uploadTextureImageSubImpl(ImageData parBufferedImage, int parInt1, int parInt2, boolean parFlag, boolean parFlag2) {
        ...
        for (int l = 0; l < i * j; l += i * k) {
            ...
            EaglercraftGPU.glTexSubImage2D(GL_TEXTURE_2D, 0, parInt1, parInt2 + i1, i, j1, GL_RGBA, GL_UNSIGNED_BYTE, dataBuffer);
        }
    }
