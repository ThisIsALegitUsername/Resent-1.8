...
public class TextureCompass extends EaglerTextureAtlasSprite {
     ...
     * direction
     */
    public void updateCompass(World worldIn, double parDouble1, double parDouble2, double parDouble3, boolean parFlag, boolean parFlag2) {
        if (!this.framesTextureData.isEmpty()) {
            ...
            if (i != this.frameCounter) {
                this.frameCounter = i;
                animationCache.copyFrameLevelsToTex2D(this.frameCounter, this.originX, this.originY, this.width, this.height);
            }
        }
    }
}
