...
public class BlockModelRenderer {
    ...
    public void renderModelBrightnessColor(IBakedModel bakedModel, float parFloat1, float parFloat2, float parFloat3, float parFloat4) {
        for (EnumFacing enumfacing : EnumFacing.values()) {
            this.renderModelBrightnessColorQuads(parFloat1, parFloat2, parFloat3, parFloat4, bakedModel.getFaceQuads(enumfacing));
        }

        this.renderModelBrightnessColorQuads(parFloat1, parFloat2, parFloat3, parFloat4, bakedModel.getGeneralQuads());
    }

    public void renderModelBrightness(IBakedModel parIBakedModel, IBlockState parIBlockState, float parFloat1, boolean parFlag) {
    ...
    private void renderModelBrightnessColorQuads(float parFloat1, float parFloat2, float parFloat3, float parFloat4, List<BakedQuad> parList) {
    ...
    class AmbientOcclusionFace {
        ...
        private int getVertexBrightness(int parInt1, int parInt2, int parInt3, int parInt4, float parFloat1, float parFloat2, float parFloat3, float parFloat4) {
            int i = (int) ((float) (parInt1 >> 16 & 255) * parFloat1 + (float) (parInt2 >> 16 & 255) * parFloat2 + (float) (parInt3 >> 16 & 255) * parFloat3 + (float) (parInt4 >> 16 & 255) * parFloat4) & 255;
            int j = (int) ((float) (parInt1 & 255) * parFloat1 + (float) (parInt2 & 255) * parFloat2 + (float) (parInt3 & 255) * parFloat3 + (float) (parInt4 & 255) * parFloat4) & 255;
            return i << 16 | j;
        }
    }
    ...
    public static enum EnumNeighborInfo {
        ...
        private EnumNeighborInfo(EnumFacing[] parArrayOfEnumFacing, float parFloat1, boolean parFlag, BlockModelRenderer.Orientation[] parArrayOfOrientation, BlockModelRenderer.Orientation[] parArrayOfOrientation_2, BlockModelRenderer.Orientation[] parArrayOfOrientation_3, BlockModelRenderer.Orientation[] parArrayOfOrientation_4) {
