...
public class TileEntityPistonRenderer extends TileEntitySpecialRenderer<TileEntityPiston> {
    ...
    public void renderTileEntityAt(TileEntityPiston tileentitypiston, double d0, double d1, double d2, float f, int var9) {
        ...
        if (block.getMaterial() != Material.air && tileentitypiston.getProgress(f) < 1.0F) {
            ...
            worldrenderer.setTranslation((double) ((float) d0 - (float) blockpos.getX() + tileentitypiston.getOffsetX(f)), (double) ((float) d1 - (float) blockpos.getY() + tileentitypiston.getOffsetY(f)), (double) ((float) d2 - (float) blockpos.getZ() + tileentitypiston.getOffsetZ(f)));
            ...
            if (block == Blocks.piston_head && tileentitypiston.getProgress(f) < 0.5F) {
                ...
                iblockstate1 = iblockstate1.withProperty(BlockPistonExtension.SHORT, Boolean.valueOf(tileentitypiston.getProgress(f) >= 0.5F));
                ...
                worldrenderer.setTranslation((double) ((float) d0 - (float) blockpos.getX()), (double) ((float) d1 - (float) blockpos.getY()), (double) ((float) d2 - (float) blockpos.getZ()));
