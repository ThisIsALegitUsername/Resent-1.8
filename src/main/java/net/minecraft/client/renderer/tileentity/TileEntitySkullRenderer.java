...
public class TileEntitySkullRenderer extends TileEntitySpecialRenderer<TileEntitySkull> {
    ...
    public void renderTileEntityAt(TileEntitySkull tileentityskull, double d0, double d1, double d2, float var8, int i) {
        EnumFacing enumfacing = EnumFacing.getFront(tileentityskull.getBlockMetadata() & 7);
        this.renderSkull((float) d0, (float) d1, (float) d2, enumfacing, (float) (tileentityskull.getSkullRotation() * 360) / 16.0F, tileentityskull.getSkullType(), tileentityskull.getPlayerProfile(), i);
    }
    ...
    public void renderSkull(float parFloat1, float parFloat2, float parFloat3, EnumFacing parEnumFacing, float parFloat4, int parInt1, GameProfile parGameProfile, int parInt2) {
