...
public class TileEntityEnchantmentTableRenderer extends TileEntitySpecialRenderer<TileEntityEnchantmentTable> {
    ...
    public void renderTileEntityAt(TileEntityEnchantmentTable tileentityenchantmenttable, double d0, double d1, double d2, float f, int var9) {
        ...
        float f5 = tileentityenchantmenttable.pageFlipPrev + (tileentityenchantmenttable.pageFlip - tileentityenchantmenttable.pageFlipPrev) * f + 0.75F;
        ...
        float f6 = tileentityenchantmenttable.bookSpreadPrev + (tileentityenchantmenttable.bookSpread - tileentityenchantmenttable.bookSpreadPrev) * f;
