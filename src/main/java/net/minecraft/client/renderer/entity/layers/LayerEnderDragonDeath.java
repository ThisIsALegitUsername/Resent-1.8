...
public class LayerEnderDragonDeath implements LayerRenderer<EntityDragon> {
    ...
    public void doRenderLayer(EntityDragon entitydragon, float var2, float var3, float f, float var5, float var6, float var7, float var8) {
        if (entitydragon.deathTicks > 0) {
            ...
            for (int i = 0; (float) i < (f1 + f1 * f1) / 2.0F * 60.0F; ++i) {
                ...
                worldrenderer.pos(-0.866D * (double) f4, (double) f3, (double) (-0.5F * f4)).color(255, 0, 255, 0).endVertex();
                worldrenderer.pos(0.866D * (double) f4, (double) f3, (double) (-0.5F * f4)).color(255, 0, 255, 0).endVertex();
