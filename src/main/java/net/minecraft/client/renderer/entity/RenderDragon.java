...
public class RenderDragon extends RenderLiving<EntityDragon> {
     ...
     */
    protected void drawRechargeRay(EntityDragon dragon, double parDouble1, double parDouble2, double parDouble3, float parFloat1) {
        float f = (float) dragon.healingEnderCrystal.innerRotation + parFloat1;
        float f1 = MathHelper.sin(f * 0.2F) / 2.0F + 0.5F;
        f1 = (f1 * f1 + f1) * 0.2F;
        float f2 = (float) (dragon.healingEnderCrystal.posX - dragon.posX - (dragon.prevPosX - dragon.posX) * (double) (1.0F - parFloat1));
        float f3 = (float) ((double) f1 + dragon.healingEnderCrystal.posY - 1.0D - dragon.posY - (dragon.prevPosY - dragon.posY) * (double) (1.0F - parFloat1));
        float f4 = (float) (dragon.healingEnderCrystal.posZ - dragon.posZ - (dragon.prevPosZ - dragon.posZ) * (double) (1.0F - parFloat1));
        ...
        float f8 = MathHelper.sqrt_float(f2 * f2 + f3 * f3 + f4 * f4) / 32.0F - ((float) dragon.ticksExisted + parFloat1) * 0.01F;
