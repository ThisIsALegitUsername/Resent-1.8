...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private boolean func_183005_a(ItemTransformVec3f parItemTransformVec3f) {
        return parItemTransformVec3f.scale.x < 0.0F ^ parItemTransformVec3f.scale.y < 0.0F ^ parItemTransformVec3f.scale.z < 0.0F;
    }
    ...
    private void func_181565_a(WorldRenderer parWorldRenderer, int parInt1, int parInt2, int parInt3, int parInt4, int parInt5, int parInt6, int parInt7, int parInt8) {
        parWorldRenderer.begin(7, DefaultVertexFormats.POSITION_COLOR);
        parWorldRenderer.pos((double) (parInt1 + 0), (double) (parInt2 + 0), 0.0D).color(parInt5, parInt6, parInt7, parInt8).endVertex();
        parWorldRenderer.pos((double) (parInt1 + 0), (double) (parInt2 + parInt4), 0.0D).color(parInt5, parInt6, parInt7, parInt8).endVertex();
        parWorldRenderer.pos((double) (parInt1 + parInt3), (double) (parInt2 + parInt4), 0.0D).color(parInt5, parInt6, parInt7, parInt8).endVertex();
        parWorldRenderer.pos((double) (parInt1 + parInt3), (double) (parInt2 + 0), 0.0D).color(parInt5, parInt6, parInt7, parInt8).endVertex();
