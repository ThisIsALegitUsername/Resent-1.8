...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase> {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float partialTicks, float scale, float parFloat3, float parFloat4, float parFloat5, float parFloat6, float parFloat7) {
        this.renderLayer(entitylivingbaseIn, partialTicks, scale, parFloat3, parFloat4, parFloat5, parFloat6, parFloat7, 4);
        this.renderLayer(entitylivingbaseIn, partialTicks, scale, parFloat3, parFloat4, parFloat5, parFloat6, parFloat7, 3);
        this.renderLayer(entitylivingbaseIn, partialTicks, scale, parFloat3, parFloat4, parFloat5, parFloat6, parFloat7, 2);
        this.renderLayer(entitylivingbaseIn, partialTicks, scale, parFloat3, parFloat4, parFloat5, parFloat6, parFloat7, 1);
    }
    ...
    private void renderLayer(EntityLivingBase entitylivingbaseIn, float armorSlot, float parFloat2, float parFloat3, float parFloat4, float parFloat5, float parFloat6, float parFloat7, int parInt1) {
    ...
    private ResourceLocation getArmorResource(ItemArmor parItemArmor, boolean parFlag, String parString1) {
        String s = HString.format("textures/models/armor/%s_layer_%d%s.png", new Object[] { parItemArmor.getArmorMaterial().getName(), Integer.valueOf(parFlag ? 2 : 1), parString1 == null ? "" : HString.format("_%s", new Object[] { parString1 }) });
