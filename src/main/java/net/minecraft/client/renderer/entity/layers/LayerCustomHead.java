...
public class LayerCustomHead implements LayerRenderer<EntityLivingBase> {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbase, float var2, float var3, float var4, float var5, float var6, float var7, float f) {
        ...
        if (itemstack != null && itemstack.getItem() != null) {
            ...
            boolean flag = entitylivingbase instanceof EntityVillager || entitylivingbase instanceof EntityZombie && ((EntityZombie) entitylivingbase).isVillager();
