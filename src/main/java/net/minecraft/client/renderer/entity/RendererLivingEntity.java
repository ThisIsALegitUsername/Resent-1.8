...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entitylivingbase, double d0, double d1, double d2, float f, float f1) {
        ...
        try {
            ...
            float f9 = entitylivingbase.prevRotationPitch + (entitylivingbase.rotationPitch - entitylivingbase.prevRotationPitch) * f1;
    ...
    protected void rotateCorpse(T entitylivingbase, float var2, float f, float f1) {
        ...
        if (entitylivingbase.deathTime > 0) {
            ...
            if (s != null && (s.equals("Dinnerbone") || s.equals("Grumm")) && (!(entitylivingbase instanceof EntityPlayer) || ((EntityPlayer) entitylivingbase).isWearing(EnumPlayerModelParts.CAPE))) {
    ...
    protected void renderLayers(T entitylivingbaseIn, float partialTicks, float parFloat2, float parFloat3, float parFloat4, float parFloat5, float parFloat6, float parFloat7) {
        for (LayerRenderer layerrenderer : this.layerRenderers) {
            ...
            layerrenderer.doRenderLayer(entitylivingbaseIn, partialTicks, parFloat2, parFloat3, parFloat4, parFloat5, parFloat6, parFloat7);
            if (flag) {
                this.unsetBrightness();
            }
        }
        ...
        if (this.canRenderName(entitylivingbase)) {
            ...
            if (d3 < (double) (f * f)) {
                ...
                if (entitylivingbase.isSneaking()) {
                    ...
                    GlStateManager.pushMatrix();
                    GlStateManager.translate((float) d0, (float) d1 + entitylivingbase.height + 0.5F - (entitylivingbase.isChild() ? entitylivingbase.height / 2.0F : 0.0F), (float) d2);
                    ...
                    this.renderOffsetLivingLabel(entitylivingbase, d0, d1 - (entitylivingbase.isChild() ? (double) (entitylivingbase.height / 2.0F) : 0.0D), d2, s, 0.02666667F, d3);
                }
            }
        }
    }
