...
public class RenderArrow extends Render<EntityArrow> {
    ...
    public void doRender(EntityArrow entityarrow, double d0, double d1, double d2, float f, float f1) {
        ...
        GlStateManager.rotate(entityarrow.prevRotationYaw + (entityarrow.rotationYaw - entityarrow.prevRotationYaw) * f1 - 90.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(entityarrow.prevRotationPitch + (entityarrow.rotationPitch - entityarrow.prevRotationPitch) * f1, 0.0F, 0.0F, 1.0F);
