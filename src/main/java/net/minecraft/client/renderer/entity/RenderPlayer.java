...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer> {
    ...
    protected void renderOffsetLivingLabel(AbstractClientPlayer abstractclientplayer, double d0, double d1, double d2, String s, float f, double d3) {
        if (d3 < 100.0D) {
            ...
            if (scoreobjective != null) {
                ...
                this.renderLivingLabel(abstractclientplayer, score.getScorePoints() + " " + scoreobjective.getDisplayName(), d0, d1, d2, 64);
    ...
    protected void renderLivingAt(AbstractClientPlayer abstractclientplayer, double d0, double d1, double d2) {
        if (abstractclientplayer.isEntityAlive() && abstractclientplayer.isPlayerSleeping()) {
            super.renderLivingAt(abstractclientplayer, d0 + (double) abstractclientplayer.renderOffsetX, d1 + (double) abstractclientplayer.renderOffsetY, d2 + (double) abstractclientplayer.renderOffsetZ);
        } else {
