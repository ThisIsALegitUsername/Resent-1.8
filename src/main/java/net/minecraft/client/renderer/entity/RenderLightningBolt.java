...
public class RenderLightningBolt extends Render<EntityLightningBolt> {
     ...
     */
    public void doRender(EntityLightningBolt entitylightningbolt, double d0, double d1, double d2, float var8, float var9) {
            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i1 = k; i1 >= l; --i1) {
                    ...
                    for (int j1 = 0; j1 < 5; ++j1) {
                        ...
                        worldrenderer.pos(d13 + d5, d1 + (double) (i1 * 16), d14 + d6).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
                        worldrenderer.pos(d11 + d7, d1 + (double) ((i1 + 1) * 16), d12 + d8).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
                    }
