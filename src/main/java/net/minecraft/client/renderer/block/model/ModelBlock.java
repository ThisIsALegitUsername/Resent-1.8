...
public class ModelBlock {
    ...
    protected ModelBlock(List<BlockPart> parList, Map<String, String> parMap, boolean parFlag, boolean parFlag2, ItemCameraTransforms parItemCameraTransforms) {
        this((ResourceLocation) null, parList, parMap, parFlag, parFlag2, parItemCameraTransforms);
    }

    protected ModelBlock(ResourceLocation parResourceLocation, Map<String, String> parMap, boolean parFlag, boolean parFlag2, ItemCameraTransforms parItemCameraTransforms) {
    ...
    private ItemTransformVec3f func_181681_a(ItemCameraTransforms.TransformType parTransformType) {
        return this.parent != null && !this.cameraTransforms.func_181687_c(parTransformType) ? this.parent.func_181681_a(parTransformType) : this.cameraTransforms.getTransform(parTransformType);
    }
