    ...
    private void registerAllBlocks() {
        ...
        this.registerBlockWithStateMapper(
                ...
                new StateMapperBase() {
                    protected ModelResourceLocation getModelResourceLocation(IBlockState iblockstate) {
                        LinkedHashMap linkedhashmap = Maps.newLinkedHashMap(iblockstate.getProperties());
                        String s = BlockStoneSlab.VARIANT.getName((BlockStoneSlab.EnumType) linkedhashmap.remove(BlockStoneSlab.VARIANT));
        ...
        this.registerBlockWithStateMapper(
                ...
                new StateMapperBase() {
                    protected ModelResourceLocation getModelResourceLocation(IBlockState iblockstate) {
                        LinkedHashMap linkedhashmap = Maps.newLinkedHashMap(iblockstate.getProperties());
                        String s = BlockStoneSlabNew.VARIANT.getName((BlockStoneSlabNew.EnumType) linkedhashmap.remove(BlockStoneSlabNew.VARIANT));
                        linkedhashmap.remove(BlockStoneSlab.SEAMLESS);
                        String s1 = ((Boolean) iblockstate.getValue(BlockStoneSlabNew.SEAMLESS)).booleanValue() ? "all" : "normal";
                        return new ModelResourceLocation(s + "_double_slab", s1);
                    }
                }
            );
