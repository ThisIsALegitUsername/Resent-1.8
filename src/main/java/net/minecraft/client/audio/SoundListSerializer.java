...
public class SoundListSerializer implements JSONTypeDeserializer<JSONObject, SoundList> {
    ...
    public SoundList deserialize(JSONObject jsonobject) throws JSONException {
        ...
        SoundCategory soundcategory = SoundCategory.getCategory(jsonobject.optString("category", SoundCategory.MASTER.getCategoryName()));
            ...
            for (int i = 0; i < jsonarray.length(); ++i) {
                ...
                if (jsonelement instanceof String) {
                    ...
                    if (jsonobject1.has("type")) {
                        SoundList.SoundEntry.Type soundlist$soundentry$type = SoundList.SoundEntry.Type.getType(jsonobject1.getString("type"));
