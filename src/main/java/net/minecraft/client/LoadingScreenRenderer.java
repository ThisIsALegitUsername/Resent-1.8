		...
		if (!this.mc.running) {
			...
			if (i - this.systemTime >= 100L) {
                ...
                worldrenderer.pos(0.0D, l, 0.0D).tex(0.0D, (float) l / f).color(64, 64, 64, 255)
						.endVertex();
                worldrenderer.pos(k, l, 0.0D).tex((float) k / f, (float) l / f)
				...
				if (progress >= 0) {
                    ...
                    worldrenderer.pos(i1, j1, 0.0D).color(128, 128, 128, 255).endVertex();
                    worldrenderer.pos(i1, j1 + b1, 0.0D).color(128, 128, 128, 255).endVertex();
                    worldrenderer.pos(i1 + b0, j1 + b1, 0.0D).color(128, 128, 128, 255)
                            .endVertex();
                    worldrenderer.pos(i1 + b0, j1, 0.0D).color(128, 128, 128, 255).endVertex();
                    worldrenderer.pos(i1, j1, 0.0D).color(128, 255, 128, 255).endVertex();
                    worldrenderer.pos(i1, j1 + b1, 0.0D).color(128, 255, 128, 255).endVertex();
                    worldrenderer.pos(i1 + progress, j1 + b1, 0.0D).color(128, 255, 128, 255)
                            .endVertex();
                    worldrenderer.pos(i1 + progress, j1, 0.0D).color(128, 255, 128, 255)
                            .endVertex();
                    tessellator.draw();
