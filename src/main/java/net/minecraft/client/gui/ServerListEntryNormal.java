...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int i, int j, int k, int l, int var5, int i1, int j1, boolean flag) {
        ...
        for (int k1 = 0; k1 < 2; ++k1) {
            if (k1 < list.size()) {
                this.mc.fontRendererObj.drawString((String) list.get(k1), j + 32 + 3, k + 12 + this.mc.fontRendererObj.FONT_HEIGHT * k1, 8421504);
            } else if (k1 == 1) {
                this.mc.fontRendererObj.drawString(this.field_148301_e.hideAddress ? I18n.format("selectServer.hiddenAddress", new Object[0]) : this.field_148301_e.serverIP, j + 32 + 3, k + 12 + this.mc.fontRendererObj.FONT_HEIGHT * k1 + k1, 0x444444);
            }
        }
        ...
        Gui.drawModalRectWithCustomSizedTexture(j + l - 15, k, (float) (b0 * 10), (float) (176 + i2 * 8), 10, 8, 256.0F, 256.0F);
