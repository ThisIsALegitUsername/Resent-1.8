...
public class SpectatorMenu {
    ...
    public ISpectatorMenuObject func_178643_a(int parInt1) {
        ...
        return this.field_178658_j > 0 && parInt1 == 0 ? field_178656_c : (parInt1 == 7 ? (i < this.field_178659_h.func_178669_a().size() ? field_178653_d : field_178654_e) : (parInt1 == 8 ? field_178655_b : (i >= 0 && i < this.field_178659_h.func_178669_a().size() ? (ISpectatorMenuObject) Objects.firstNonNull(this.field_178659_h.func_178669_a().get(i), field_178657_a) : field_178657_a)));
    }
