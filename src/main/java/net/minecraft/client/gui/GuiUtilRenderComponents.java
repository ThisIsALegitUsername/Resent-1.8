...
public class GuiUtilRenderComponents {
    ...
    public static String func_178909_a(String parString1, boolean parFlag) {
        return !parFlag && !Minecraft.getMinecraft().gameSettings.chatColours ? EnumChatFormatting.getTextWithoutFormattingCodes(parString1) : parString1;
    }

    public static List<IChatComponent> func_178908_a(IChatComponent parIChatComponent, int parInt1, FontRenderer parFontRenderer, boolean parFlag, boolean parFlag2) {
        int i = 0;
