...
public abstract class GuiContainer extends GuiScreen {
    ...
    protected void mouseClicked(int parInt1, int parInt2, int parInt3) {
        ...
        this.doubleClick = this.lastClickSlot == slot && i - this.lastClickTime < 250L && this.lastClickButton == parInt3;
    ...
    protected void keyTyped(char parChar1, int parInt1) {
        if (parInt1 == this.mc.gameSettings.keyBindClose.getKeyCode() || parInt1 == this.mc.gameSettings.keyBindInventory.getKeyCode() || (parInt1 == 1 && (this.mc.gameSettings.keyBindClose.getKeyCode() == 0 || this.mc.areKeysLocked()))) {
