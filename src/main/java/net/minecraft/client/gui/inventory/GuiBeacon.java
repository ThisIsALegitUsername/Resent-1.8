...
public class GuiBeacon extends GuiContainer {
    ...
    public void updateScreen() {
        ...
        if (this.buttonsNotDrawn && i >= 0) {
            ...
            for (int k2 = 0; k2 < i2 - 1; ++k2) {
                ...
                GuiBeacon.PowerButton guibeacon$powerbutton2 = new GuiBeacon.PowerButton(b0 << 8 | l2, this.guiLeft + 167 + k2 * 24 - j2 / 2, this.guiTop + 47, l2, b0);
            ...
            if (j > 0) {
                GuiBeacon.PowerButton guibeacon$powerbutton1 = new GuiBeacon.PowerButton(b0 << 8 | j, this.guiLeft + 167 + (i2 - 1) * 24 - j2 / 2, this.guiTop + 47, j, b0);
    ...
    static class Button extends GuiButton {
        ...
        protected Button(int parInt1, int parInt2, int parInt3, ResourceLocation parResourceLocation, int parInt4, int parInt5) {
    ...
    class PowerButton extends GuiBeacon.Button {
        ...
        public PowerButton(int parInt1, int parInt2, int parInt3, int parInt4, int parInt5) {
            super(parInt1, parInt2, parInt3, GuiContainer.inventoryBackground, 0 + Potion.potionTypes[parInt4].getStatusIconIndex() % 8 * 18, 198 + Potion.potionTypes[parInt4].getStatusIconIndex() / 8 * 18);
