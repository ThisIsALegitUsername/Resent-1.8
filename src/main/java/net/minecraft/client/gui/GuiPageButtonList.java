...
public class GuiPageButtonList extends GuiListExtended {
    ...
    public GuiPageButtonList(Minecraft mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn, GuiPageButtonList.GuiResponder parGuiResponder, GuiPageButtonList.GuiListEntry[]... parArrayOfarray) {
    ...
    private Gui func_178058_a(GuiPageButtonList.GuiListEntry parGuiListEntry, int parInt1, boolean parFlag) {
        return (Gui) (
            parGuiListEntry instanceof GuiPageButtonList.GuiSlideEntry
                ? this.func_178067_a(this.width / 2 - 155 + parInt1, 0, (GuiPageButtonList.GuiSlideEntry) parGuiListEntry)
                : (
                    parGuiListEntry instanceof GuiPageButtonList.GuiButtonEntry
                        ? this.func_178065_a(this.width / 2 - 155 + parInt1, 0, (GuiPageButtonList.GuiButtonEntry) parGuiListEntry)
                        : (parGuiListEntry instanceof GuiPageButtonList.EditBoxEntry ? this.func_178068_a(this.width / 2 - 155 + parInt1, 0, (GuiPageButtonList.EditBoxEntry) parGuiListEntry) : (parGuiListEntry instanceof GuiPageButtonList.GuiLabelEntry ? this.func_178063_a(this.width / 2 - 155 + parInt1, 0, (GuiPageButtonList.GuiLabelEntry) parGuiListEntry, parFlag) : null))
                )
        );
    }
    ...
    private GuiSlider func_178067_a(int parInt1, int parInt2, GuiPageButtonList.GuiSlideEntry parGuiSlideEntry) {
        GuiSlider guislider = new GuiSlider(this.field_178076_z, parGuiSlideEntry.func_178935_b(), parInt1, parInt2, parGuiSlideEntry.func_178936_c(), parGuiSlideEntry.func_178943_e(), parGuiSlideEntry.func_178944_f(), parGuiSlideEntry.func_178942_g(), parGuiSlideEntry.func_178945_a());
    ...
    private GuiListButton func_178065_a(int parInt1, int parInt2, GuiPageButtonList.GuiButtonEntry parGuiButtonEntry) {
        GuiListButton guilistbutton = new GuiListButton(this.field_178076_z, parGuiButtonEntry.func_178935_b(), parInt1, parInt2, parGuiButtonEntry.func_178936_c(), parGuiButtonEntry.func_178940_a());
    ...
    private GuiTextField func_178068_a(int parInt1, int parInt2, GuiPageButtonList.EditBoxEntry parEditBoxEntry) {
        GuiTextField guitextfield = new GuiTextField(parEditBoxEntry.func_178935_b(), this.mc.fontRendererObj, parInt1, parInt2, 150, 20);
    ...
    private GuiLabel func_178063_a(int parInt1, int parInt2, GuiPageButtonList.GuiLabelEntry parGuiLabelEntry, boolean parFlag) {
        GuiLabel guilabel;
        if (parFlag) {
            guilabel = new GuiLabel(this.mc.fontRendererObj, parGuiLabelEntry.func_178935_b(), parInt1, parInt2, this.width - parInt1 * 2, 20, -1);
        } else {
            guilabel = new GuiLabel(this.mc.fontRendererObj, parGuiLabelEntry.func_178935_b(), parInt1, parInt2, 150, 20, -1);
        }
    ...
    public static class GuiSlideEntry extends GuiPageButtonList.GuiListEntry {
        ...
        public GuiSlideEntry(int parInt1, String parString1, boolean parFlag, GuiSlider.FormatHelper parFormatHelper, float parFloat1, float parFloat2, float parFloat3) {
            super(parInt1, parString1, parFlag);
