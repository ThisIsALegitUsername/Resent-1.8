...
public class GuiCommandBlock extends GuiScreen {
	...
	public void initGui() {
        ...
        this.buttonList.add(this.doneBtn = new GuiButton(0, width / 2 - 4 - 150, height / 4 + 120 + 12, 150,
                20, I18n.format("gui.done")));
        this.buttonList.add(this.cancelBtn = new GuiButton(1, width / 2 + 4, height / 4 + 120 + 12, 150, 20,
	...
	public void drawScreen(int i, int j, float f) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("advMode.setCommand"), width / 2,
                20, 16777215);
        this.drawString(this.fontRendererObj, I18n.format("advMode.command"), width / 2 - 150, 37,
                10526880);
		this.commandTextField.drawTextBox();
		int k = 75;
		int l = 0;
        this.drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer"), width / 2 - 150,
                k + l++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer"), width / 2 - 150,
                k + l++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers"), width / 2 - 150,
                k + l++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.allEntities"), width / 2 - 150,
                k + l++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, "", width / 2 - 150, k + l++ * this.fontRendererObj.FONT_HEIGHT,
                10526880);
