...
public class GuiScreenAddServer extends GuiScreen {
    ...
    public void initGui() {
        ...
        GuiButton done;
        GuiButton cancel;
        this.buttonList.add(done = new GuiButton(0, this.width / 2 - 100, i + 96 + 12, I18n.format("addServer.add", new Object[0])));
        this.buttonList.add(cancel = new GuiButton(1, this.width / 2 - 100, i + 120 + 12, I18n.format("gui.cancel", new Object[0])));
        ...
        this.buttonList.add(this.serverResourcePacks = new GuiButton(2, this.width / 2 - 100, i + 54, I18n.format("addServer.resourcePack", new Object[0]) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
        this.buttonList.add(this.hideAddress = new GuiButton(3, this.width / 2 - 100, i + 78, I18n.format("addServer.hideAddress", new Object[0]) + ": " + I18n.format(this.serverData.hideAddress ? "gui.yes" : "gui.no", new Object[0])));
    ...
    protected void actionPerformed(GuiButton parGuiButton) {
        if (parGuiButton.enabled) {
            if (parGuiButton.id == 3) {
                ...
                this.hideAddress.displayString = I18n.format("addServer.hideAddress", new Object[0]) + ": " + I18n.format(this.serverData.hideAddress ? "gui.yes" : "gui.no", new Object[0]);
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if (EagRuntime.requireSSL()) {
            this.drawCenteredString(this.fontRendererObj, I18n.format("addServer.SSLWarn1"), this.width / 2, 184, 0xccccff);
            this.drawCenteredString(this.fontRendererObj, I18n.format("addServer.SSLWarn2"), this.width / 2, 196, 0xccccff);
        }
