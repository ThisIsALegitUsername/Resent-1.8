...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
    ...
    protected void func_175258_a(ScaledResolution parScaledResolution, float parFloat1, int parInt1, float parFloat2, SpectatorDetails parSpectatorDetails) {
        ...
        if (parSpectatorDetails.func_178681_b() >= 0) {
            this.drawTexturedModalRect((float) (parInt1 - 91 - 1 + parSpectatorDetails.func_178681_b() * 20), parFloat2 - 1.0F, 0, 22, 24, 22);
        }

        RenderHelper.enableGUIStandardItemLighting();

        for (int i = 0; i < 9; ++i) {
            this.func_175266_a(i, parScaledResolution.getScaledWidth() / 2 - 90 + i * 20 + 2, parFloat2 + 3.0F, parFloat1, parSpectatorDetails.func_178680_a(i));
        }
    ...
    private void func_175266_a(int parInt1, int parInt2, float parFloat1, float parFloat2, ISpectatorMenuObject parISpectatorMenuObject) {
        ...
        if (parISpectatorMenuObject != SpectatorMenu.field_178657_a) {
            ...
            String s = String.valueOf(GameSettings.getKeyDisplayString(this.field_175268_g.gameSettings.keyBindsHotbar[parInt1].getKeyCode()));
            if (i > 3 && parISpectatorMenuObject.func_178662_A_()) {
                this.field_175268_g.fontRendererObj.drawStringWithShadow(s, (float) (parInt2 + 19 - 2 - this.field_175268_g.fontRendererObj.getStringWidth(s)), parFloat1 + 6.0F + 3.0F, 16777215 + (i << 24));
            }
        }
    }
    ...
    public void func_175263_a(ScaledResolution parScaledResolution) {
        ...
        if (i > 3 && this.field_175271_i != null) {
            ...
            if (s != null) {
                int j = (parScaledResolution.getScaledWidth() - this.field_175268_g.fontRendererObj.getStringWidth(s)) / 2;
    ...
    public void func_175259_b(int parInt1) {
        int i;
        for (i = this.field_175271_i.func_178648_e() + parInt1; i >= 0 && i <= 8 && (this.field_175271_i.func_178643_a(i) == SpectatorMenu.field_178657_a || !this.field_175271_i.func_178643_a(i).func_178662_A_()); i += parInt1) {}
