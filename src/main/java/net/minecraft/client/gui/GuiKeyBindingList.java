...
public class GuiKeyBindingList extends GuiListExtended {
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int var1, int var2, int i, int var4, int j, int var6, int var7, boolean var8) {
            GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.labelText, GuiKeyBindingList.this.mc.currentScreen.width / 2 - this.labelWidth / 2, i + j - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry {
        ...
        private KeyEntry(KeyBinding parKeyBinding) {
            ...
            this.btnChangeKeyBinding = new GuiButton(0, 0, 0, 75, 20, I18n.format(parKeyBinding.getKeyDescription(), new Object[0]));
        ...
        public void drawEntry(int var1, int i, int j, int var4, int k, int l, int i1, boolean var8) {
            ...
            GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.keyDesc, i + 90 - GuiKeyBindingList.this.maxListLabelWidth, j + k / 2 - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT / 2, 16777215);
