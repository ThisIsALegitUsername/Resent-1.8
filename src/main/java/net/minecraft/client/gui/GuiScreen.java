...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    public void drawScreen(int i, int j, float var3) {
        ...
        if (closeKeyTimeout < 3000l) {
            ...
            if (closeKeyTimeout > 2500l) GlStateManager.enableBlend();
            fontRendererObj.drawStringWithShadow(str, x + 2, y + 2, 0xFFAAAA | alpha2);
            if (closeKeyTimeout > 2500l) GlStateManager.disableBlend();
        }
    }
    ...
    protected void keyTyped(char parChar1, int parInt1) {
        if (((this.mc.theWorld == null || this.mc.thePlayer.getHealth() <= 0.0F) && parInt1 == 1) || parInt1 == this.mc.gameSettings.keyBindClose.getKeyCode() || (parInt1 == 1 && (this.mc.gameSettings.keyBindClose.getKeyCode() == 0 || this.mc.areKeysLocked()))) {
        ...
        if (parIChatComponent != null && parIChatComponent.getChatStyle().getChatHoverEvent() != null) {
            ...
            if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
                ...
                if (this.mc.gameSettings.advancedItemTooltips) {
                    try {
                        NBTTagCompound nbttagcompound2 = JsonToNBT.getTagFromJson(hoverevent.getValue().getUnformattedText());
                ...
                this.drawHoveringText(NEWLINE_SPLITTER.splitToList(hoverevent.getValue().getFormattedText()), parInt1, parInt2);
                ...
                if (statbase != null) {
                    ...
                    ArrayList arraylist = Lists.newArrayList(new String[] { ichatcomponent.getFormattedText(), chatcomponenttranslation.getFormattedText() });
                    if (s1 != null) {
                    ...
                    this.drawCreativeTabHoveringText(EnumChatFormatting.RED + "Invalid statistic/achievement!", parInt1, parInt2);
                }
            }
