...
public class GuiScreenServerList extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (EagRuntime.requireSSL()) {
            this.field_146302_g = new GuiTextField(2, this.fontRendererObj, this.width / 2 - 100, this.height / 4 + 35, 200, 20);
        } else {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        if (EagRuntime.requireSSL()) {
            this.drawString(this.fontRendererObj, I18n.format("addServer.enterIp", new Object[0]), this.width / 2 - 100, this.height / 4 + 19, 10526880);
            this.drawCenteredString(this.fontRendererObj, I18n.format("addServer.SSLWarn1"), this.width / 2, this.height / 4 + 30 + 37, 0xccccff);
            this.drawCenteredString(this.fontRendererObj, I18n.format("addServer.SSLWarn2"), this.width / 2, this.height / 4 + 30 + 49, 0xccccff);
        } else {
