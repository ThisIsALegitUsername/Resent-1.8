...
public class GuiOptionsRowList extends GuiListExtended {
    ...
    public GuiOptionsRowList(Minecraft mcIn, int parInt1, int parInt2, int parInt3, int parInt4, int parInt5, GameSettings.Options... parArrayOfOptions) {
        ...
        for (int i = 0; i < parArrayOfOptions.length; i += 2) {
            ...
            GameSettings.Options gamesettings$options1 = i < parArrayOfOptions.length - 1 ? parArrayOfOptions[i + 1] : null;
    ...
    private GuiButton func_148182_a(Minecraft mcIn, int parInt1, int parInt2, GameSettings.Options parOptions) {
        if (parOptions == null) {
            ...
            return (GuiButton) (parOptions.getEnumFloat() ? new GuiOptionSlider(i, parInt1, parInt2, parOptions) : new GuiOptionButton(i, parInt1, parInt2, parOptions, mcIn.gameSettings.getKeyBinding(parOptions)));
        }
    }
