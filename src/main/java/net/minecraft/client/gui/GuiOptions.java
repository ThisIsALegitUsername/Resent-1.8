...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(broadcastSettings = new GuiButton(107, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, I18n.format(EagRuntime.getRecText(), new Object[0])));
        ...
        GuiButton rp;
        this.buttonList.add(rp = new GuiButton(105, this.width / 2 - 155, this.height / 6 + 144 - 6, 150, 20, I18n.format("options.resourcepack", new Object[0])));
        GuiButton b;
        this.buttonList.add(b = new GuiButton(104, this.width / 2 + 5, this.height / 6 + 144 - 6, 150, 20, I18n.format("options.snooper.view", new Object[0])));
        b.enabled = false;
    ...
    public String func_175355_a(EnumDifficulty parEnumDifficulty) {
        ...
        chatcomponenttext.appendSibling(new ChatComponentTranslation(parEnumDifficulty.getDifficultyResourceKey(), new Object[0]));
    ...
    protected void actionPerformed(GuiButton parGuiButton) {
        if (parGuiButton.enabled) {
            if (parGuiButton.id < 100 && parGuiButton instanceof GuiOptionButton) {
                ...
                parGuiButton.displayString = this.game_settings_1.getKeyBinding(GameSettings.Options.getEnumOptions(parGuiButton.id));
            }
