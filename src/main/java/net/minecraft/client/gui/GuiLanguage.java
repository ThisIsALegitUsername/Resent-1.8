...
public class GuiLanguage extends GuiScreen {
            ...
            switch (parGuiButton.id) {
                ...
                case 100:
                    if (parGuiButton instanceof GuiOptionButton) {
                        ...
                        parGuiButton.displayString = this.game_settings_3.getKeyBinding(GameSettings.Options.FORCE_UNICODE_FONT);
    ...
    class List extends GuiSlot {
        ...
        protected boolean isSelected(int i) {
            return ((String) this.langCodeList.get(i)).equals(GuiLanguage.this.languageManager.getCurrentLanguage().getLanguageCode());
        }
        ...
        protected void drawSlot(int i, int var2, int j, int var4, int var5, int var6) {
            ...
            GuiLanguage.this.drawCenteredString(GuiLanguage.this.fontRendererObj, ((Language) this.languageMap.get(this.langCodeList.get(i))).toString(), this.width / 2, j + 1, 16777215);
