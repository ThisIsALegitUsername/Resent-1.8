...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback {
	...
	public void initGui() {
		...
		if (this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled()) {
			if (this.mc.isIntegratedServerRunning()) {
                this.buttonList.add(new GuiButton(1, width / 2 - 100, height / 4 + 96,
            ...
            this.buttonList.add(new GuiButton(0, width / 2 - 100, height / 4 + 72,
	...
	public void drawScreen(int i, int j, float f) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("deathScreen.score") + ": "
                + EnumChatFormatting.YELLOW + this.mc.thePlayer.getScore(), width / 2, 100, 16777215);
