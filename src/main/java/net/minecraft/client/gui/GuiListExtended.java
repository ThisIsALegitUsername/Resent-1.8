...
public abstract class GuiListExtended extends GuiSlot {
    ...
    protected void drawSlot(int entryID, int mouseXIn, int mouseYIn, int parInt4, int parInt5, int parInt6) {
        this.getListEntry(entryID).drawEntry(entryID, mouseXIn, mouseYIn, this.getListWidth(), parInt4, parInt5, parInt6, this.getSlotIndexFromScreenCoords(parInt5, parInt6) == entryID);
    }
