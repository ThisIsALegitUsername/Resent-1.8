...
public class GuiEnchantment extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
        ...
        GlStateManager.viewport((scaledresolution.getScaledWidth() - 290 - 110) / 2 * scaledresolution.getScaleFactor(), (scaledresolution.getScaledHeight() - 220 + 60) / 2 * scaledresolution.getScaleFactor(), 290 * scaledresolution.getScaleFactor(), 220 * scaledresolution.getScaleFactor());
