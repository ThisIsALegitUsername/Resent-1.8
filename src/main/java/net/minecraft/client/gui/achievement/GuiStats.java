...
public class GuiStats extends GuiScreen implements IProgressMeter {
    ...
    private void drawSprite(int parInt1, int parInt2, int parInt3, int parInt4) {
        ...
        worldrenderer.pos((double) (parInt1 + 0), (double) (parInt2 + 18), (double) this.zLevel).tex((double) ((float) (parInt3 + 0) * 0.0078125F), (double) ((float) (parInt4 + 18) * 0.0078125F)).endVertex();
        worldrenderer.pos((double) (parInt1 + 18), (double) (parInt2 + 18), (double) this.zLevel).tex((double) ((float) (parInt3 + 18) * 0.0078125F), (double) ((float) (parInt4 + 18) * 0.0078125F)).endVertex();
        worldrenderer.pos((double) (parInt1 + 18), (double) (parInt2 + 0), (double) this.zLevel).tex((double) ((float) (parInt3 + 18) * 0.0078125F), (double) ((float) (parInt4 + 0) * 0.0078125F)).endVertex();
        worldrenderer.pos((double) (parInt1 + 0), (double) (parInt2 + 0), (double) this.zLevel).tex((double) ((float) (parInt3 + 0) * 0.0078125F), (double) ((float) (parInt4 + 0) * 0.0078125F)).endVertex();
        tessellator.draw();
    }
    ...
    abstract class Stats extends GuiSlot {
        ...
        protected void func_148209_a(StatBase parStatBase, int parInt1, int parInt2, boolean parFlag) {
            if (parStatBase != null) {
                ...
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s, parInt1 - GuiStats.this.fontRendererObj.getStringWidth(s), parInt2 + 5, parFlag ? 16777215 : 9474192);
            } else {
                String s1 = "-";
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, parInt1 - GuiStats.this.fontRendererObj.getStringWidth(s1), parInt2 + 5, parFlag ? 16777215 : 9474192);
            }
        }
    ...
    class StatsGeneral extends GuiSlot {
        ...
        protected void drawSlot(int i, int j, int k, int var4, int var5, int var6) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, statbase.getStatName().getUnformattedText(), j + 2, k + 1, i % 2 == 0 ? 16777215 : 9474192);
            String s = statbase.format(GuiStats.this.field_146546_t.readStat(statbase));
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s, j + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s), k + 1, i % 2 == 0 ? 16777215 : 9474192);
        }
    }
    ...
    class StatsMobsList extends GuiSlot {
        ...
        protected void drawSlot(int i, int j, int k, int var4, int var5, int var6) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, j + 2, k + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT, l == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, j + 2, k + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2, i1 == 0 ? 6316128 : 9474192);
        }
    }
}
