...
public class ModelRenderer {
    ...
    public ModelRenderer addBox(float parFloat1, float parFloat2, float parFloat3, int parInt1, int parInt2, int parInt3, boolean parFlag) {
        this.cubeList.add(new ModelBox(this, this.textureOffsetX, this.textureOffsetY, parFloat1, parFloat2, parFloat3, parInt1, parInt2, parInt3, 0.0F, parFlag));
        return this;
    }
    ...
    public void addBox(float width, float height, float depth, int scaleFactor, int parInt2, int parInt3, float parFloat4) {
        this.cubeList.add(new ModelBox(this, this.textureOffsetX, this.textureOffsetY, width, height, depth, scaleFactor, parInt2, parInt3, parFloat4));
    }
            ...
            if (this.showModel) {
                ...
                if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F) {
                    if (this.rotationPointX == 0.0F && this.rotationPointY == 0.0F && this.rotationPointZ == 0.0F) {
                        ...
                        GlStateManager.translate(this.rotationPointX * parFloat1, this.rotationPointY * parFloat1, this.rotationPointZ * parFloat1);
                        GlStateManager.callList(this.displayList);
                        if (this.childModels != null) {
