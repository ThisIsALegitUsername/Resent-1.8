...
public class ModelHorse extends ModelBase {
    ...
    public void render(Entity entity, float var2, float var3, float var4, float var5, float var6, float f) {
        ...
        if (!flag) {
            ...
            if (f1 <= 0.0F) {
                ...
                GlStateManager.translate(0.0F, 0.9F * (1.0F - f2) * f1 + 1.35F * (1.0F - f2) * (1.0F - f1), 0.15F * (1.0F - f2) * f1);
            }
        }
     ...
     */
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float partialTickTime, float parFloat2, float parFloat3) {
        super.setLivingAnimations(entitylivingbaseIn, partialTickTime, parFloat2, parFloat3);
        float f = this.updateHorseRotation(entitylivingbaseIn.prevRenderYawOffset, entitylivingbaseIn.renderYawOffset, parFloat3);
        float f1 = this.updateHorseRotation(entitylivingbaseIn.prevRotationYawHead, entitylivingbaseIn.rotationYawHead, parFloat3);
        float f2 = entitylivingbaseIn.prevRotationPitch + (entitylivingbaseIn.rotationPitch - entitylivingbaseIn.prevRotationPitch) * parFloat3;
        float f3 = f1 - f;
        ...
        this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + MathHelper.sin(1.5707964F + f15 + f7 * -f10 * 0.5F * parFloat2) * 7.0F;
        this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ + MathHelper.cos(4.712389F + f15 + f7 * -f10 * 0.5F * parFloat2) * 7.0F;
        this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + MathHelper.sin(1.5707964F + f15 + f7 * f10 * 0.5F * parFloat2) * 7.0F;
        this.backRightShin.rotationPointZ = this.backRightLeg.rotationPointZ + MathHelper.cos(4.712389F + f15 + f7 * f10 * 0.5F * parFloat2) * 7.0F;
        ...
        this.backLeftShin.rotateAngleX = -0.08726646F * f6 + (-f10 * 0.5F * parFloat2 - Math.max(0.0F, f10 * 0.5F * parFloat2)) * f7;
