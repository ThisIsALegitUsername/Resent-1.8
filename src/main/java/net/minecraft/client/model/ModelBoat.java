...
public class ModelBoat extends ModelBase {
	...
	public ModelBoat() {
        ...
        this.boatSides[1].setRotationPoint((float) (-b0 / 2 + 1), b3, 0.0F);
        this.boatSides[2].addBox((float) (-b0 / 2 + 2), (float) (-b1 - 1), -1.0F, b0 - 4, b1, 2, 0.0F);
        this.boatSides[2].setRotationPoint((float) (b0 / 2 - 1), b3, 0.0F);
        this.boatSides[3].addBox((float) (-b0 / 2 + 2), (float) (-b1 - 1), -1.0F, b0 - 4, b1, 2, 0.0F);
        this.boatSides[3].setRotationPoint(0.0F, b3, (float) (-b2 / 2 + 1));
        this.boatSides[4].addBox((float) (-b0 / 2 + 2), (float) (-b1 - 1), -1.0F, b0 - 4, b1, 2, 0.0F);
        this.boatSides[4].setRotationPoint(0.0F, b3, (float) (b2 / 2 - 1));
