...
public class PotionHelper {
    ...
    private static int func_77904_a(boolean parFlag, boolean parFlag2, boolean parFlag3, int parInt1, int parInt2, int parInt3, int parInt4) {
        int i = 0;
        if (parFlag) {
     ...
     */
    private static int brewBitOperations(int parInt1, int parInt2, boolean parFlag, boolean parFlag2, boolean parFlag3) {
        if (parFlag3) {
    ...
    public static int func_77908_a(int parInt1, int parInt2, int parInt3, int parInt4, int parInt5, int parInt6) {
        return (checkFlag(parInt1, parInt2) ? 16 : 0) | (checkFlag(parInt1, parInt3) ? 8 : 0) | (checkFlag(parInt1, parInt4) ? 4 : 0) | (checkFlag(parInt1, parInt5) ? 2 : 0) | (checkFlag(parInt1, parInt6) ? 1 : 0);
    }
