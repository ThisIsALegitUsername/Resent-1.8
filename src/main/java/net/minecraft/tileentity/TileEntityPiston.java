...
public class TileEntityPiston extends TileEntity implements ITickable {
    ...
    private void launchWithSlimeBlock(float parFloat1, float parFloat2) {
        ...
        AxisAlignedBB axisalignedbb = Blocks.piston_extension.getBoundingBox(this.worldObj, this.pos, this.pistonState, parFloat1, this.pistonFacing);
            ...
            if (!list.isEmpty()) {
                ...
                for (Entity entity : this.field_174933_k) {
                    if (this.pistonState.getBlock() == Blocks.slime_block && this.extending) {
                        ...
                        entity.moveEntity((double) (parFloat2 * (float) this.pistonFacing.getFrontOffsetX()), (double) (parFloat2 * (float) this.pistonFacing.getFrontOffsetY()), (double) (parFloat2 * (float) this.pistonFacing.getFrontOffsetZ()));
                    }
                }
