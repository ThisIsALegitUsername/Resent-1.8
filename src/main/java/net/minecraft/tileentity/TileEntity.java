        ...
        reportCategory.addCrashSectionCallable(
            ...
            new Callable<String>() {
                public String call() throws Exception {
                    return (String) TileEntity.classToNameMap.get(TileEntity.this.getClass()) + " // " + TileEntity.this.getClass().getName();
                }
            }
        );
        if (this.worldObj != null) {
            ...
            reportCategory.addCrashSectionCallable(
                ...
                new Callable<String>() {
                    public String call() throws Exception {
                        ...
                        try {
                            return HString.format("ID #%d (%s // %s)", new Object[] { Integer.valueOf(i), Block.getBlockById(i).getUnlocalizedName(), Block.getBlockById(i).getClass().getName() });
