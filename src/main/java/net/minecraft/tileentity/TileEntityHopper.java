...
public class TileEntityHopper extends TileEntityLockable implements IHopper, ITickable {
    ...
    public static boolean captureDroppedItems(IHopper parIHopper) {
        ...
        if (iinventory != null) {
            ...
            for (EntityItem entityitem : func_181556_a(parIHopper.getWorld(), parIHopper.getXPos(), parIHopper.getYPos() + 1.0D, parIHopper.getZPos())) {
    ...
    public static List<EntityItem> func_181556_a(World parWorld, double parDouble1, double parDouble2, double parDouble3) {
        return parWorld.<EntityItem>getEntitiesWithinAABB(EntityItem.class, new AxisAlignedBB(parDouble1 - 0.5D, parDouble2 - 0.5D, parDouble3 - 0.5D, parDouble1 + 0.5D, parDouble2 + 0.5D, parDouble3 + 0.5D), EntitySelectors.selectAnything);
    }
