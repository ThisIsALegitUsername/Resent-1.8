            ...
            if (jsonobject == null) {
                ...
                if (jsonobject.has("clickEvent")) {
                    ...
                    if (jsonobject1 != null) {
                        ...
                        ClickEvent.Action clickevent$action = jsonprimitive == null ? null : ClickEvent.Action.getValueByCanonicalName(jsonprimitive);
                        String jsonprimitive1 = jsonobject1.optString("value");
                        if (clickevent$action != null && jsonprimitive1 != null && clickevent$action.shouldAllowInChat()) {
                ...
                if (jsonobject.has("hoverEvent")) {
                    ...
                    if (jsonobject2 != null) {
                        ...
                        HoverEvent.Action hoverevent$action = jsonprimitive2 == null ? null : HoverEvent.Action.getValueByCanonicalName(jsonprimitive2);
                        IChatComponent ichatcomponent = JSONTypeProvider.deserializeNoCast(jsonobject2.get("value"), IChatComponent.class);
        ...
        public JSONObject serialize(ChatStyle chatstyle) {
            if (chatstyle.isEmpty()) {
                ...
                if (chatstyle.chatHoverEvent != null) {
                    ...
                    jsonobject2.put("value", (JSONObject) JSONTypeProvider.serialize(chatstyle.chatHoverEvent.getValue()));
