...
public class MathHelper {
    ...
    public static double denormalizeClamp(double parDouble1, double parDouble2, double parDouble3) {
        return parDouble3 < 0.0D ? parDouble1 : (parDouble3 > 1.0D ? parDouble2 : parDouble1 + (parDouble2 - parDouble1) * parDouble3);
    }
    ...
    public static int func_180183_b(float parFloat1, float parFloat2, float parFloat3) {
        return func_180181_b(floor_float(parFloat1 * 255.0F), floor_float(parFloat2 * 255.0F), floor_float(parFloat3 * 255.0F));
    }
    ...
    public static int func_181758_c(float parFloat1, float parFloat2, float parFloat3) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                break;
            default:
                throw new RuntimeException("Something went wrong when converting from HSV to RGB. Input was " + parFloat1 + ", " + parFloat2 + ", " + parFloat3);
        }
