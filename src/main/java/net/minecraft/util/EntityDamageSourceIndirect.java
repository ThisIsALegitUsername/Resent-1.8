...
public class EntityDamageSourceIndirect extends EntityDamageSource {
    ...
    public IChatComponent getDeathMessage(EntityLivingBase entitylivingbase) {
        ...
        String s1 = s + ".item";
        return itemstack != null && itemstack.hasDisplayName() && StatCollector.canTranslate(s1) ? new ChatComponentTranslation(s1, new Object[] { entitylivingbase.getDisplayName(), ichatcomponent, itemstack.getChatComponent() }) : new ChatComponentTranslation(s, new Object[] { entitylivingbase.getDisplayName(), ichatcomponent });
    }
}
