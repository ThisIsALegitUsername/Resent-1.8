        ...
        public IChatComponent deserialize(Object parJsonElement) throws JSONException {
            if (parJsonElement instanceof String) {
                ...
                if (parJsonElement instanceof JSONArray) {
                    ...
                    throw new JSONException("Don\'t know how to turn " + parJsonElement.getClass().getSimpleName() + " into a Component");
                }
            } else {
                ...
                if (jsonobject.has("text")) {
                    ...
                    if (!jsonobject.has("selector")) {
                        throw new JSONException("Don\'t know how to turn " + parJsonElement.toString() + " into a Component");
                    }
