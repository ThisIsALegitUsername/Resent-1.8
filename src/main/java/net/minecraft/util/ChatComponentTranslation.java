    ...
    protected void initializeFromFormat(String format) {
        ...
        try {
            ...
            for (; matcher.find(j); j = l) {
                ...
                l = matcher.end();
                if (k > j) {
                    ChatComponentText chatcomponenttext = new ChatComponentText(HString.format(format.substring(j, k), new Object[0]));
            ...
            if (j < format.length()) {
                ChatComponentText chatcomponenttext1 = new ChatComponentText(HString.format(format.substring(j), new Object[0]));
