...
public class DamageSource {
    ...
    public static DamageSource causeFireballDamage(EntityFireball fireball, Entity parEntity) {
        return parEntity == null ? (new EntityDamageSourceIndirect("onFire", fireball, fireball)).setFireDamage().setProjectile() : (new EntityDamageSourceIndirect("fireball", fireball, parEntity)).setFireDamage().setProjectile();
    }
    ...
    public static DamageSource causeIndirectMagicDamage(Entity parEntity, Entity parEntity2) {
        return (new EntityDamageSourceIndirect("indirectMagic", parEntity, parEntity2)).setDamageBypassesArmor().setMagicDamage();
    }
    ...
    public IChatComponent getDeathMessage(EntityLivingBase parEntityLivingBase) {
        ...
        String s1 = s + ".player";
        return entitylivingbase != null && StatCollector.canTranslate(s1) ? new ChatComponentTranslation(s1, new Object[] { parEntityLivingBase.getDisplayName(), entitylivingbase.getDisplayName() }) : new ChatComponentTranslation(s, new Object[] { parEntityLivingBase.getDisplayName() });
    }
