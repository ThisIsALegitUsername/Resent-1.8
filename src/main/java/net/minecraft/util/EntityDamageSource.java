...
public class EntityDamageSource extends DamageSource {
    ...
    public IChatComponent getDeathMessage(EntityLivingBase entitylivingbase) {
        ...
        String s1 = s + ".item";
        return itemstack != null && itemstack.hasDisplayName() && StatCollector.canTranslate(s1) ? new ChatComponentTranslation(s1, new Object[] { entitylivingbase.getDisplayName(), this.damageSourceEntity.getDisplayName(), itemstack.getChatComponent() }) : new ChatComponentTranslation(s, new Object[] { entitylivingbase.getDisplayName(), this.damageSourceEntity.getDisplayName() });
    }
