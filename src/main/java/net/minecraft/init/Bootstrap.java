            ...
            new IBehaviorDispenseItem() {
                ...
                public ItemStack dispense(IBlockSource iblocksource, final ItemStack itemstack) {
                    return ItemPotion.isSplash(itemstack.getMetadata())
                        ...
                        : this.field_150843_b.dispense(iblocksource, itemstack);
                }
            }
        );
        BlockDispenser.dispenseBehaviorRegistry.putObject(
            ...
            new BehaviorDefaultDispenseItem() {
                public ItemStack dispenseStack(IBlockSource iblocksource, ItemStack itemstack) {
                    ...
                    Entity entity = ItemMonsterPlacer.spawnCreature(iblocksource.getWorld(), itemstack.getMetadata(), d0, d1, d2);
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(
            ...
            new BehaviorDefaultDispenseItem() {
                public ItemStack dispenseStack(IBlockSource iblocksource, ItemStack itemstack) {
                    ...
                    double d1 = (double) ((float) iblocksource.getBlockPos().getY() + 0.2F);
                    double d2 = iblocksource.getZ() + (double) enumfacing.getFrontOffsetZ();
                    EntityFireworkRocket entityfireworkrocket = new EntityFireworkRocket(iblocksource.getWorld(), d0, d1, d2, itemstack);
