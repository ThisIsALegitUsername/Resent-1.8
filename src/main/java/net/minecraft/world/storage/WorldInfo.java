...
public class WorldInfo {
    ...
    public void addToCrashReport(CrashReportCategory category) {
        ...
        category.addCrashSectionCallable(
            ...
            new Callable<String>() {
                public String call() throws Exception {
                    return HString.format("ID %02d - %s, ver %d. Features enabled: %b", new Object[] { Integer.valueOf(WorldInfo.this.terrainType.getWorldTypeID()), WorldInfo.this.terrainType.getWorldTypeName(), Integer.valueOf(WorldInfo.this.terrainType.getGeneratorVersion()), Boolean.valueOf(WorldInfo.this.mapFeaturesEnabled) });
                }
            }
        );
        category.addCrashSectionCallable(
        ...
        category.addCrashSectionCallable(
            ...
            new Callable<String>() {
                public String call() throws Exception {
                    return HString.format("%d game time, %d day time", new Object[] { Long.valueOf(WorldInfo.this.totalTime), Long.valueOf(WorldInfo.this.worldTime) });
                }
            }
        );
        category.addCrashSectionCallable(
        ...
        category.addCrashSectionCallable(
            ...
            new Callable<String>() {
                public String call() throws Exception {
                    return HString.format("Rain time: %d (now: %b), thunder time: %d (now: %b)", new Object[] { Integer.valueOf(WorldInfo.this.rainTime), Boolean.valueOf(WorldInfo.this.raining), Integer.valueOf(WorldInfo.this.thunderTime), Boolean.valueOf(WorldInfo.this.thundering) });
                }
            }
        );
        category.addCrashSectionCallable(
            ...
            new Callable<String>() {
                public String call() throws Exception {
                    return HString.format("Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", new Object[] { WorldInfo.this.theGameType.getName(), Integer.valueOf(WorldInfo.this.theGameType.getID()), Boolean.valueOf(WorldInfo.this.hardcore), Boolean.valueOf(WorldInfo.this.allowCommands) });
                }
            }
        );
    }
