...
public class NoiseGeneratorSimplex {
    ...
    public void func_151606_a(double[] parArrayOfDouble, double parDouble1, double parDouble2, int parInt1, int parInt2, double parDouble3, double parDouble4, double parDouble5) {
        int i = 0;
