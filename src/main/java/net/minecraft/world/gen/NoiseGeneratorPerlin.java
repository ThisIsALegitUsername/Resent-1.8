...
public class NoiseGeneratorPerlin extends NoiseGenerator {
    ...
    public double[] func_151599_a(double[] parArrayOfDouble, double parDouble1, double parDouble2, int parInt1, int parInt2, double parDouble3, double parDouble4, double parDouble5) {
        return this.func_151600_a(parArrayOfDouble, parDouble1, parDouble2, parInt1, parInt2, parDouble3, parDouble4, parDouble5, 0.5D);
    }

    public double[] func_151600_a(double[] parArrayOfDouble, double parDouble1, double parDouble2, int parInt1, int parInt2, double parDouble3, double parDouble4, double parDouble5, double parDouble6) {
        ...
        for (int j = 0; j < this.field_151602_b; ++j) {
            this.field_151603_a[j].func_151606_a(parArrayOfDouble, parDouble1, parDouble2, parInt1, parInt2, parDouble3 * d0 * d1, parDouble4 * d0 * d1, 0.55D / d1);
            d0 *= parDouble5;
            d1 *= parDouble6;
        }
