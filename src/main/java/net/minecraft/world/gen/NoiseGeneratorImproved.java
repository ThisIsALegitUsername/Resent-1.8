...
public class NoiseGeneratorImproved extends NoiseGenerator {
     ...
     */
    public void populateNoiseArray(double[] parArrayOfDouble, double parDouble1, double parDouble2, double parDouble3, int parInt1, int parInt2, int parInt3, double parDouble4, double parDouble5, double parDouble6, double parDouble7) {
        if (parInt2 == 1) {
            int i5 = 0;
            int j5 = 0;
            int j = 0;
