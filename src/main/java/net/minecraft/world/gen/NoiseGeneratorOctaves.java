...
public class NoiseGeneratorOctaves extends NoiseGenerator {
     ...
     */
    public double[] generateNoiseOctaves(double[] parArrayOfDouble, int parInt1, int parInt2, int parInt3, int parInt4, int parInt5, int parInt6, double parDouble1, double parDouble2, double parDouble3) {
        ...
        for (int j = 0; j < this.octaves; ++j) {
            ...
            d0 = d0 + (double) k;
            d2 = d2 + (double) l;
            this.generatorCollection[j].populateNoiseArray(parArrayOfDouble, d0, d1, d2, parInt4, parInt5, parInt6, parDouble1 * d3, parDouble2 * d3, parDouble3 * d3, d3);
            d3 /= 2.0D;
        }
     ...
     * Bouncer function to the main one with some default arguments.
     */
    public double[] generateNoiseOctaves(double[] parArrayOfDouble, int parInt1, int parInt2, int parInt3, int parInt4, double parDouble1, double parDouble2, double parDouble3) {
        return this.generateNoiseOctaves(parArrayOfDouble, parInt1, 10, parInt2, parInt3, 1, parInt4, parDouble1, 1.0D, parDouble2);
    }
}
