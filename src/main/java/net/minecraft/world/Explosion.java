...
public class Explosion {
    ...
    public Explosion(World worldIn, Entity parEntity, double parDouble1, double parDouble2, double parDouble3, float parFloat1, List<BlockPos> parList) {
        this(worldIn, parEntity, parDouble1, parDouble2, parDouble3, parFloat1, false, true, parList);
    }

    public Explosion(World worldIn, Entity parEntity, double parDouble1, double parDouble2, double parDouble3, float parFloat1, boolean parFlag, boolean parFlag2, List<BlockPos> parList) {
    ...
    public Explosion(World worldIn, Entity parEntity, double parDouble1, double parDouble2, double parDouble3, float size, boolean parFlag, boolean parFlag2) {
    ...
    public void doExplosionA() {
        ...
        List list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, new AxisAlignedBB((double) j1, (double) l1, (double) i2, (double) k1, (double) l, (double) i1));
