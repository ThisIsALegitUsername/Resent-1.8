...
public abstract class BiomeGenBase {
    ...
    protected static final NoiseGeneratorPerlin temperatureNoise = new NoiseGeneratorPerlin(new EaglercraftRandom(1234L), 1);
    protected static final NoiseGeneratorPerlin GRASS_COLOR_NOISE = new NoiseGeneratorPerlin(new EaglercraftRandom(2345L), 1);
                ...
                if (iblockstate2.getBlock().getMaterial() == Material.air) {
                    ...
                    if (j == -1) {
                        ...
                        if (j1 < i && (iblockstate == null || iblockstate.getBlock().getMaterial() == Material.air)) {
                            if (this.getFloatTemperature(blockpos$mutableblockpos.func_181079_c(parInt1, j1, parInt2)) < 0.15F) {
