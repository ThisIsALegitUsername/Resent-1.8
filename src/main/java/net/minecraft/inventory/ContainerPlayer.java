            ...
            this.addSlotToContainer(
                    new Slot(playerInventory, playerInventory.getSizeInventory() - 1 - k, 8, 8 + k * 18) {
                        ...
                        public boolean isItemValid(ItemStack itemstack) {
                            return itemstack == null ? false : (itemstack.getItem() instanceof ItemArmor ? ((ItemArmor) itemstack.getItem()).armorType == k2 : (itemstack.getItem() != Item.getItemFromBlock(Blocks.pumpkin) && itemstack.getItem() != Items.skull ? false : k2 == 0));
                        }
