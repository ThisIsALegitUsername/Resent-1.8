...
public class ContainerEnchantment extends Container {
    ...
    public boolean enchantItem(EntityPlayer entityplayer, int i) {
        ...
        if ((itemstack1 == null || itemstack1.stackSize < j) && !entityplayer.capabilities.isCreativeMode) {
            return false;
        } else if (this.enchantLevels[i] > 0 && itemstack != null && (entityplayer.experienceLevel >= j && entityplayer.experienceLevel >= this.enchantLevels[i] || entityplayer.capabilities.isCreativeMode)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean canInteractWith(EntityPlayer entityplayer) {
        return this.worldPointer.getBlockState(this.position).getBlock() != Blocks.enchanting_table ? false : entityplayer.getDistanceSq((double) this.position.getX() + 0.5D, (double) this.position.getY() + 0.5D, (double) this.position.getZ() + 0.5D) <= 64.0D;
    }
