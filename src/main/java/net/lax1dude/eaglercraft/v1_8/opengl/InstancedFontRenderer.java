...
public class InstancedFontRenderer {
    ...
    public static void render(float charWidth, float charHeight, float charCoordWidth, float charCoordHeight, boolean shadow) {
        ...
        if (!fogEnabled) {
            ...
            if (stateColorBiasR != 0.0f || stateColorBiasG != 0.0f || stateColorBiasB != 0.0f || stateColorBiasA != 0.0f) {
            ...
            if (stateColorBiasR != biasR || stateColorBiasG != biasG || stateColorBiasB != biasB || stateColorBiasA != biasA) {
