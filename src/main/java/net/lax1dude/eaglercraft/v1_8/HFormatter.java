...
public final class HFormatter implements Closeable, Flushable {
     ...
     *                                      is not supported.
     */
    public HFormatter(String fileName, String csn, Locale l) throws FileNotFoundException, UnsupportedEncodingException {
    ...
    private static class Transformer {
        ...
        private String transformFromFloat() {
            ...
            // output result
            FloatUtil floatUtil = new FloatUtil(result, formatToken, (DecimalFormat) NumberFormat.getInstance(locale), arg);
