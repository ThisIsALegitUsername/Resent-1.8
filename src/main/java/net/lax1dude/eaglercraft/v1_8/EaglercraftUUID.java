...
public class EaglercraftUUID implements Comparable<EaglercraftUUID> {
        ...
        if (name.length() == 36) {
            ...
            if (ch1 == '-' && ch2 == '-' && ch3 == '-' && ch4 == '-') {
                ...
                if ((msb1 | msb2 | msb3 | msb4 | lsb1 | lsb2 | lsb3 | lsb4) >= 0) {
                    return new EaglercraftUUID(msb1 << 48 | msb2 << 32 | msb3 << 16 | msb4, lsb1 << 48 | lsb2 << 32 | lsb3 << 16 | lsb4);
                }
            }
        }
    ...
    public int compareTo(EaglercraftUUID val) {
        return (this.msb < val.msb ? -1 : (this.msb > val.msb ? 1 : (this.lsb < val.lsb ? -1 : (this.lsb > val.lsb ? 1 : 0))));
    }
}
