...
public class GuiAuthenticationScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(continueButton = new GuiButton(1, this.width / 2 - 100, this.height / 4 + 80 + 12, I18n.format("auth.continue", new Object[0])));
        continueButton.enabled = false;
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 80 + 37, I18n.format("gui.cancel", new Object[0])));
    ...
    public void drawScreen(int i, int j, float var3) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("auth.required", new Object[0]), this.width / 2, this.height / 4 - 5, 16777215);
