    ...
    public void log(Level level, String msg) {
        if (level.levelInt >= LogManager.logLevel.levelInt) {
            synchronized (LogManager.logLock) {
                ...
                ps.println("[" + fmt.format(dateInstance) + "]" + "[" + Thread.currentThread().getName() + "/" + level.levelName + "]" + "[" + loggerName + "]: " + msg);
            }
        }
    }
    ...
    public void log(Level level, String msg, Object... args) {
        if (level.levelInt >= LogManager.logLevel.levelInt) {
            synchronized (LogManager.logLock) {
                PrintStream ps = level.getPrintStream();
                dateInstance.setTime(System.currentTimeMillis());
                ps.println("[" + fmt.format(dateInstance) + "]" + "[" + Thread.currentThread().getName() + "/" + level.levelName + "]" + "[" + loggerName + "]: " + formatParams(msg, args));
            }
        }
    }
