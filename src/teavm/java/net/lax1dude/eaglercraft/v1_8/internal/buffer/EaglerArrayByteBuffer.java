...
public class EaglerArrayByteBuffer implements ByteBuffer {
    ...
    public ByteBuffer put(ByteBuffer src) {
        if (src instanceof EaglerArrayByteBuffer) {
            ...
            Uint8Array.create(dataView.getBuffer()).set(Uint8Array.create(c.dataView.getBuffer(), o + c.position, c.limit - c.position), dataView.getByteOffset() + position);
            position += l;
            c.position += l;
        } else {
            int l = src.remaining();
    ...
    public long getLong() {
        ...
        long l = dataView.getUint32(position) | ((long) dataView.getUint8(position + 4) << 32) | ((long) dataView.getUint8(position + 5) << 40) | ((long) dataView.getUint8(position + 6) << 48) | ((long) dataView.getUint8(position + 7) << 56);
        position += 8;
        return l;
    }
    ...
    public long getLong(int index) {
        ...
        return dataView.getUint32(index, true) | ((long) dataView.getUint8(index + 4) << 32) | ((long) dataView.getUint8(index + 5) << 40) | ((long) dataView.getUint8(index + 6) << 48) | ((long) dataView.getUint8(index + 7) << 56);
    }
